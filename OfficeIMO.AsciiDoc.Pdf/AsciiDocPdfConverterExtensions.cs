...
public static class AsciiDocPdfConverterExtensions {
    ...
    public static PdfCore.PdfDocument ToPdfDocument(this AsciiDocDocument document, AsciiDocToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfDocumentConversionResult ToPdfDocumentResult(this AsciiDocDocument document, AsciiDocToPdfOptions? options = null) =>
        AsciiDocPdfConversionEngine.Convert(document, options);

    /// <summary>Converts an AsciiDoc document to PDF bytes.</summary>
    public static byte[] ToPdfBytes(this AsciiDocDocument document, AsciiDocToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdf(this AsciiDocDocument document, string path, AsciiDocToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdf(this AsciiDocDocument document, Stream stream, AsciiDocToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this AsciiDocDocument document, string path, AsciiDocToPdfOptions? options = null) {
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this AsciiDocDocument document, Stream stream, AsciiDocToPdfOptions? options = null) {
