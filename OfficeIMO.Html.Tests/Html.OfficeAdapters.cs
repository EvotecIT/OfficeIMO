...
public class HtmlOfficeAdapters {
    ...
    public void PowerPointHtml_ExportsSemanticSlidesWithExtractionProof() {
        ...
        using (var image = new MemoryStream(OnePixelPng)) {
            PowerPointPicture picture = slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 72, 140, 72, 72);
    ...
    public void PowerPointHtml_ExportsPositionedReviewSlides() {
        ...
        using (var image = new MemoryStream(OnePixelPng)) {
            PowerPointPicture picture = slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 72, 180, 72, 72);
    ...
    public void PowerPointHtml_SemanticSlidesSkipHiddenShapesByDefault() {
        ...
        hidden.Hidden = true;
        using (var image = new MemoryStream(OnePixelPng)) {
            PowerPointPicture hiddenPicture = slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 80, 90, 120, 72);
    ...
    public void PowerPointHtml_RoundTripsOffSlidePicturePosition() {
        ...
        PowerPointSlide slide = presentation.AddSlide();
        using (var image = new MemoryStream(OnePixelPng)) {
            slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, -18, -12, 72, 72);
        }
    ...
    public void PowerPointHtml_RoundTripsPictureTransforms() {
        ...
        PowerPointSlide slide = presentation.AddSlide();
        using (var image = new MemoryStream(OnePixelPng)) {
            PowerPointPicture picture = slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 80, 90, 120, 72);
    ...
    public void PowerPointHtml_RejectsCropPairsThatConsumeTheWholePicture() {
        ...
        PowerPointSlide slide = presentation.AddSlide();
        using (var image = new MemoryStream(OnePixelPng)) {
            slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 40, 40, 80, 60)
                .Crop(10D, 0D, 10D, 0D);
        }
        string html = presentation.ToHtml(new PowerPointHtmlSaveOptions {
            Profile = OfficeHtmlConversionProfile.PowerPointSemanticSlides
    ...
    public void PowerPointHtml_RoundTripsChartTransformsAndMixedDrawingOrder() {
        ...
        using (var image = new MemoryStream(OnePixelPng)) {
            PowerPointPicture picture = slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 96, 100, 80, 64);
    ...
    public void PowerPointHtml_VisualReviewStretchesPositionedPicturesToAuthoredShape() {
        ...
        PowerPointSlide slide = presentation.AddSlide();
        using (var image = new MemoryStream(OnePixelPng)) {
            slide.AddPicturePoints(image, OfficeIMO.PowerPoint.PowerPointImagePartType.Png, 40, 50, 180, 60);
        }
