...
namespace OfficeIMO.Tests {
    public partial class Html {
        ...
        public void HtmlToWord_TableCaptionAbove() {
            ...
            var doc = OfficeIMO.Html.HtmlConversionDocument.Parse(html).ToWordDocument(new HtmlToWordOptions { TableCaptionPosition = TableCaptionPosition.Above });
        ...
        public void HtmlToWord_TableCaptionBelow() {
            ...
            var doc = OfficeIMO.Html.HtmlConversionDocument.Parse(html).ToWordDocument(new HtmlToWordOptions { TableCaptionPosition = TableCaptionPosition.Below });
            var bodyXml = doc._wordprocessingDocument!.MainDocumentPart!.Document.Body!.OuterXml;
