...
public sealed class OfficeDocumentOcrExecutionOptions {
    ...
    /// <summary>Maximum aggregate characters retained across span text and span metadata. Defaults to 4 Mi characters.</summary>
    public int MaxSpanCharactersPerCandidate { get; set; } = 4 * 1024 * 1024;

    /// <summary>Maximum aggregate characters retained in result provider, model, and language metadata. Defaults to 16 Ki characters.</summary>
    public int MaxResultMetadataCharactersPerCandidate { get; set; } = 16 * 1024;

    /// <summary>Maximum provider diagnostics retained from one engine response. Defaults to 1,000.</summary>
    public int MaxProviderDiagnosticsPerCandidate { get; set; } = 1_000;

    /// <summary>Maximum aggregate provider diagnostic code, message, and source characters. Defaults to 1 Mi characters.</summary>
    public int MaxProviderDiagnosticCharactersPerCandidate { get; set; } = 1 * 1024 * 1024;

    /// <summary>Maximum aggregate provider diagnostic attributes retained per candidate. Defaults to 10,000.</summary>
    public int MaxProviderDiagnosticAttributesPerCandidate { get; set; } = 10_000;

    /// <summary>Maximum aggregate provider diagnostic attribute key and value characters. Defaults to 1 Mi characters.</summary>
    public int MaxProviderDiagnosticAttributeCharactersPerCandidate { get; set; } = 1 * 1024 * 1024;
    ...
    public OfficeDocumentOcrExecutionOptions Clone() {
        ...
        return new OfficeDocumentOcrExecutionOptions {
            ...
            MaxResultMetadataCharactersPerCandidate = MaxResultMetadataCharactersPerCandidate,
            MaxProviderDiagnosticsPerCandidate = MaxProviderDiagnosticsPerCandidate,
            MaxProviderDiagnosticCharactersPerCandidate = MaxProviderDiagnosticCharactersPerCandidate,
            MaxProviderDiagnosticAttributesPerCandidate = MaxProviderDiagnosticAttributesPerCandidate,
            MaxProviderDiagnosticAttributeCharactersPerCandidate = MaxProviderDiagnosticAttributeCharactersPerCandidate,
