...
/// <summary>
/// CSV/TSV ingestion helpers for <see cref="OfficeDocumentReader"/>.
/// </summary>
internal static class CsvReaderAdapter {
    /// <summary>
    /// Reads CSV/TSV content from a path with table-aware chunking.
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(string path, ReaderOptions? readerOptions = null, CsvReadOptions? csvOptions = null, CancellationToken cancellationToken = default) {
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(Stream stream, string? sourceName = null, ReaderOptions? readerOptions = null, CsvReadOptions? csvOptions = null, CancellationToken cancellationToken = default) {
