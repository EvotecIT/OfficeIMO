...
public static class MhtmlDiagnosticCodes {
    ...
    /// <summary>More than one related part can be selected through the same filename or location resolver identity.</summary>
    public const string DuplicateResourceIdentity = "MHTML_RESOURCE_IDENTITY_DUPLICATE";
