...
internal static class OfficeDocumentImageDimensions {
    internal static bool TryReadPixelDimensions(byte[] payload, string? mediaType, out int width, out int height) {
        width = 0;
        height = 0;
