...
public static partial class ExcelOpenDocumentConversionExtensions {
    ...
    public static OdfConversionResult<ExcelDocument> ToExcelDocumentResult(this OdsDocument source,
        ...
        if (convertedConditionalStyles.Count > 0) report.Add("source-conditional-style-maps",
            ...
            "Single numeric cell-content comparisons and literal numeric between/not-between conditions with a fill are mapped to Excel differential-fill rules; other applied-style properties and ODF evaluation details are not transferred.");
