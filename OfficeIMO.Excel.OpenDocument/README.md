...
Conditional-formatting rules remain native to their source format. The adapter reports Excel rules and ODF conditional style maps as unsupported during conversion; it does not silently treat either as a basic cell style.
