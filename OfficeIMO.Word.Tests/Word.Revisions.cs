...
namespace OfficeIMO.Tests {
    public partial class Word {
        ...
        public void Test_Revisions_MoveRangeOperationsPromoteMatchingMoveText() {
            ...
            using (WordDocument document = WordDocument.Load(acceptPath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
                Body body = document._document.Body!;
            ...
            using (WordDocument document = WordDocument.Load(rejectPath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
                Body body = document._document.Body!;
