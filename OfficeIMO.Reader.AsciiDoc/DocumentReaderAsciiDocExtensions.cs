...
/// <summary>AsciiDoc ingestion entry points for <see cref="DocumentReader"/>.</summary>
public static class DocumentReaderAsciiDocExtensions {
    /// <summary>Reads an AsciiDoc file into source-aware Reader chunks.</summary>
    public static IEnumerable<ReaderChunk> ReadAsciiDocFile(
        string path,
    ...
    public static IEnumerable<ReaderChunk> ReadAsciiDoc(
        Stream stream,
    ...
    public static IEnumerable<ReaderChunk> ReadAsciiDocDocument(
