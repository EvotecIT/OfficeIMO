...
public static partial class OfficeDrawingSvgExporter {
    private static void AppendEffectGroup(StringBuilder sb, OfficeDrawingEffectGroup effectGroup, ref int gradientId, ref int clipPathId) {
        ...
        if (effectGroup.SoftMask != null) {
            ...
            AppendSoftMaskDefinition(sb, maskId, effectGroup.SoftMask, ref gradientId, ref clipPathId);
        }
    ...
    private static void AppendSoftMaskDefinition(StringBuilder sb, string id, OfficeDrawingSoftMask mask, ref int gradientId, ref int clipPathId) {
        ...
        AppendElements(sb, mask.InnerDrawing.Elements, ref gradientId, ref clipPathId);
