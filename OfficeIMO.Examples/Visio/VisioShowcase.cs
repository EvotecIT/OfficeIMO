    ...
    public static class VisioShowcase {
        public static void Example_VisioShowcase(string folderPath, bool openVisio, bool exportPreviews) {
            ...
            List<VisioShowcaseExample> examples = new() {
                ...
                new VisioShowcaseExample("15 Premium scenario showcase", () => PremiumVisioShowcase.Example_PremiumVisioShowcase(showcasePath, false))
            };
            ...
            if (!string.IsNullOrWhiteSpace(externalStencilPack) && File.Exists(externalStencilPack)) {
                examples.Add(new VisioShowcaseExample("16 External VSSX stencil pack", () => ExternalStencilPack.Example_ExternalStencilPack(showcasePath, false, externalStencilPack)));
            }
            ...
            if (MicrosoftIntegrationAzureStencils.IsConfigured(integrationStencilPack)) {
                examples.Add(new VisioShowcaseExample("17 Microsoft Integration/Azure stencil graph", () => MicrosoftIntegrationAzureStencils.Example_MicrosoftIntegrationAzureStencils(showcasePath, false, integrationStencilPack!)));
            }
            ...
            if (ExternalStencilGallery.IsConfigured(stencilGalleryPath)) {
                examples.Add(new VisioShowcaseExample("18 External stencil catalog gallery", () => ExternalStencilGallery.Example_ExternalStencilGallery(showcasePath, false, stencilGalleryPath!)));
            }
            if (global::OfficeIMO.Visio.Stencils.VisioStencilPackageCatalog.DiscoverInstalledVisioPackages().Count > 0) {
                examples.Add(new VisioShowcaseExample("19 Installed Visio stencil packages", () => InstalledVisioStencils.Example_InstalledVisioStencils(showcasePath, false)));
            }
