...
namespace OfficeIMO.Examples {
    internal static class Program {
        ...
        static void Main(string[] args) {
            ...
            // SaveToStream.Example_StreamDocumentProperties(folderPath, false);            // Protect.Example_ProtectFinalDocument(folderPath, false);            Protect.Example_ProtectAlwaysReadOnly(folderPath, true);
            Protect.Example_ProtectDocumentPasswordVsReadOnlyRecommended(folderPath, true);
            Protect.Debug_TestPasswordHashes();
            Protect.Example_TestReadOnlyRecommendations(folderPath, false);
