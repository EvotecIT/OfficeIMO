...
namespace OfficeIMO.Examples.Html {
    internal static partial class Html {
        public static void Example_Html08_SemanticsAndCitations(string folderPath, bool openWord) {
            Console.WriteLine("[*] HTML Semantics: blockquote/cite, abbr/dfn, figure");

            string htmlPath = Path.Combine(AppContext.BaseDirectory, "Converters", "Html", "Content", "v1-footnotes-citations.html");
            ...
            string docxPath = Path.Combine(folderPath, "Html08_SemanticsAndCitations.docx");
            doc.Save(docxPath);
