    ...
    internal static partial class Shapes {
        internal static void Example_ShapesAdvanced(string folderPath, bool openWord) {
            ...
            using (WordDocument document = WordDocument.Create(filePath)) {
                ...
                var rect = p1.AddShape(WordShapeType.Rectangle, 90, 40, Color.Aqua, Color.Navy, 2);
                rect.Left = 20; rect.Top = 20;

                // VML ellipse rotated
                var p2 = document.AddParagraph("VML Ellipse rotated 25°");
                var ell = p2.AddShape(WordShapeType.Ellipse, 80, 40, Color.Gold, Color.Black, 1.25);
                ...
                var rrect = p3.AddShape(WordShapeType.RoundedRectangle, 100, 50, Color.LightGreen, Color.DarkGreen, 1, arcSize: 0.6);
                ...
                var dml = p6.AddShapeDrawing(WordShapeType.Rectangle, 90, 30, 20, 240);
                ...
                var d13 = p13.AddShapeDrawing(WordShapeType.Donut, 90, 90, 280, 330);
                ...
                var d14 = p14.AddShapeDrawing(WordShapeType.Can, 80, 100, 400, 320);
                ...
                var d15 = p15.AddShapeDrawing(WordShapeType.Cube, 90, 90, 500, 330);
