    ...
    internal static partial class Shapes {
        internal static void Example_AddMultipleShapes(string folderPath, bool openWord) {
            ...
            using (WordDocument document = WordDocument.Create(filePath)) {
                ...
                var rect = p1.AddShape(80, 40, OfficeIMO.Drawing.OfficeColor.Green);
                ...
                var poly = WordShape.AddPolygon(p5, "0,0 60,0 30,50 0,0", OfficeIMO.Drawing.OfficeColor.Purple, OfficeIMO.Drawing.OfficeColor.Black);
