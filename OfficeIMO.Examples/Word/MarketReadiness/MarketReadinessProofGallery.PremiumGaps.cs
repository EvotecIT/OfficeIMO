...
namespace OfficeIMO.Examples.Word {
    internal static partial class MarketReadinessProofGallery {
        ...
        private static void CreateFeaturePreflightProof(string scenarioPath) {
            ...
            using (WordDocument document = WordDocument.Load(featurePath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
        ...
        private static void CreateReviewReportProof(string scenarioPath) {
            ...
            using (WordDocument document = WordDocument.Load(reviewPath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
        ...
        private static void CreateSignaturePreflightProof(string scenarioPath) {
            ...
            using (WordDocument document = WordDocument.Load(signaturePath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
