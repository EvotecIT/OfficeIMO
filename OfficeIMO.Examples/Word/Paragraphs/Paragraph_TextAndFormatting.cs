...
namespace OfficeIMO.Examples.Word.Paragraphs {
    internal static class Paragraph_TextAndFormatting {
        public static void Example_Word_Fluent_Paragraph_TextAndFormatting(string folderPath, bool openWord) {
