...
namespace OfficeIMO.Examples.Word {
    internal static partial class CompareDocuments {
        internal static void Example_ReportAndRedlineWorkflow(string folderPath, bool openWord) {
            ...
            using (WordDocument redline = WordDocument.Load(redlinePath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
            ...
            using (WordDocument inPlaceRedline = WordDocument.Load(inPlaceRedlinePath, new WordLoadOptions { AccessMode = OfficeIMO.DocumentAccessMode.ReadOnly })) {
