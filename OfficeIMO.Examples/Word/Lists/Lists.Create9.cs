    ...
    internal static partial class Lists {
        internal static void Example_BasicLists9(string folderPath, bool openWord) {
            ...
            using (WordDocument document = WordDocument.Create(filePath)) {
                ...
                paragraph = document.AddParagraph("This is 3rd list - UpperLetterWithDot").SetColor(Color.DeepPink).SetUnderline(WordUnderlineStyle.Double);
                paragraph.ParagraphAlignment = WordParagraphAlignment.Center;
                ...
                paragraph = document.AddParagraph("This is 4th list - UpperLetterWithBracket").SetColor(Color.Aqua).SetUnderline(WordUnderlineStyle.Double);
                paragraph.ParagraphAlignment = WordParagraphAlignment.Center;
