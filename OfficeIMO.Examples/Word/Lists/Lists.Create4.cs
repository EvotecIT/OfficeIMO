    ...
    internal static partial class Lists {
        internal static void Example_BasicLists2(string folderPath, bool openWord) {
            ...
            using (WordDocument document = WordDocument.Create(filePath)) {
                ...
                paragraph = document.AddParagraph("This is 6th list").SetColor(Color.DeepPink).SetUnderline(WordUnderlineStyle.Double);
                ...
                paragraph = document.AddParagraph("This is 7th list").SetColor(Color.DeepPink).SetUnderline(WordUnderlineStyle.Double);
