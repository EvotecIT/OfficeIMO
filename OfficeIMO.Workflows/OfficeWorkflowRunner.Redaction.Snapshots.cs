...
public sealed partial class OfficeWorkflowRunner {
    private static PdfRedactionWorkflowRequest SnapshotRedactionRequest(PdfRedactionWorkflowRequest request) {
        ...
        return new PdfRedactionWorkflowRequest {
            ...
            PhysicalInputRoot = request.PhysicalInputRoot,
            PhysicalOutputRoot = request.PhysicalOutputRoot,
            PhysicalOutputPublicationPath = request.PhysicalOutputPublicationPath,
            PhysicalEvidencePublicationPath = request.PhysicalEvidencePublicationPath,
