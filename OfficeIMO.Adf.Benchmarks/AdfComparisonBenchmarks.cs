...
/// <summary>Measures the typed ADF parse cost against the narrower platform JSON-tree floor.</summary>
[MemoryDiagnoser]
public class AdfParseBenchmarks {
    ...
    [Benchmark(Baseline = true, Description = "System.Text.Json cost floor")]
...
/// <summary>Measures a semantic JSON round trip against the narrower platform JSON-tree floor.</summary>
[MemoryDiagnoser]
