...
[void] $overview.AppendLine('description: "Navigate the complete managed document platform by workflow, component family, generated API, and validation evidence. Find examples and API links."')
...
[void] $packagePage.AppendLine('description: "A source-derived index of every production OfficeIMO library, adapter, renderer, and tool. Includes examples and API links."')
