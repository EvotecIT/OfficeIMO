...
if ($aotMatrix.summary.nativeAotValidatedProjectCount -ne 111) {
    Add-Failure "The NativeAOT matrix validates $($aotMatrix.summary.nativeAotValidatedProjectCount) projects; expected 111."
}
if ($aotMatrix.summary.fullyRootedLibraryCount -ne 108 -or
