...
if ($aotMatrix.summary.nativeAotValidatedProjectCount -ne 110) {
    Add-Failure "The NativeAOT matrix validates $($aotMatrix.summary.nativeAotValidatedProjectCount) projects; expected 110."
}
if ($aotMatrix.summary.fullyRootedLibraryCount -ne 107 -or
