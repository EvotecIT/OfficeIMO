...
OfficeIMO is a modular document platform, not a single basic DOCX helper. The repository currently contains **91 production libraries, adapters, renderers, and tools**, backed by **31 test projects**, **13 benchmark projects**, and dedicated validation applications.
...
- **Formats and interoperability:** 13 focused components
