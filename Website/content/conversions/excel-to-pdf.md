...
meta.primary_label: "Convert XLSX to PDF in the browser"
meta.primary_url: "/convert/?workspace=convert&route=xlsx-pdf"
meta.secondary_label: "Read the Excel guide"
meta.secondary_url: "/docs/excel/"
meta.summary_title: "Excel to PDF summary"
meta.limit: "PDF pagination is not worksheet geometry. Validate wide sheets, print areas, page breaks, hidden content, and required fonts."
