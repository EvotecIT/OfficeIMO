...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|Yes, for 90 of the 91 production projects. The project matrix records 88 fully rooted libraries, one bounded Google APIs workflow, one native command-line tool, and the managed-only WPF/WebView2 renderer."
