...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|Yes, for 92 of the 93 production projects. The project matrix records 90 fully rooted libraries, one bounded Google APIs workflow, one native command-line tool, and the managed-only WPF/WebView2 renderer."
