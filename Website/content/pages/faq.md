...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|Yes, for 88 of the 89 production projects. The project matrix records 86 fully rooted libraries, one bounded Google APIs workflow, one native command-line tool, and the managed-only WPF/WebView2 renderer."
