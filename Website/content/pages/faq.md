...
meta.faq.questions:
  ...
  - "Does OfficeIMO support DOC, XLS, XLSB, and PPT as well as DOCX, XLSX, and PPTX?|OfficeIMO classifies and reads modern and legacy Word, Excel, and PowerPoint families, writes documented native subsets, and reports conversion coverage by operation and fidelity."
  ...
  - "Is NativeAOT compilation supported?|The OfficeIMO validation matrix covers production libraries, bounded Google APIs workflows, native command-line tools, managed cross-platform applications such as the Chromium bridge and OfficeIMO Studio, and the managed-only WPF/WebView2 renderer. Check the matrix for the exact package and runtime path."
