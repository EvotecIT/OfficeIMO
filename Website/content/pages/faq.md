...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|The OfficeIMO validation matrix covers production libraries, bounded Google APIs workflows, native command-line tools, the managed cross-platform Chromium bridge, and the managed-only WPF/WebView2 renderer. Check the matrix for the exact package and runtime path."
