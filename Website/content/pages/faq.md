...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|The OfficeIMO 3.2 validation matrix covers 97 of 98 production projects: 95 fully rooted libraries, one bounded Google APIs workflow, one native command-line tool, and one managed-only WPF/WebView2 renderer. Check the matrix for the exact package and runtime path."
