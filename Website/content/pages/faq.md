...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|Yes, for 91 of the 92 production projects. The project matrix records 89 fully rooted libraries, one bounded Google APIs workflow, one native command-line tool, and the managed-only WPF/WebView2 renderer."
