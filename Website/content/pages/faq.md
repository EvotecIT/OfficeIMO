...
meta.faq.questions:
  ...
  - "Is NativeAOT compilation supported?|The OfficeIMO 3.2 validation matrix covers 96 of 97 production projects: 94 fully rooted libraries, one bounded Google APIs workflow, one native command-line tool, and one managed-only WPF/WebView2 renderer. Check the matrix for the exact package and runtime path."
