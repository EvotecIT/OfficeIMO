...
<article class="ocx-capability-card"><span class="ocx-chip ocx-chip--warn">Next browser route</span><h3>HTML to DOCX</h3><p>Complete the web-content bridge after style and image handling are validated.</p><code>html.ToWordDocument().ToDocx()</code></article>
