...
public sealed class OfflineAddressBookListInfo {
    internal OfflineAddressBookListInfo(
        ...
        Name = OabPropertyValues.String(headerProperties, OabPropertyTags.AddressBookName);
        DistinguishedName = OabPropertyValues.String(headerProperties, OabPropertyTags.AddressBookDistinguishedName);
        Sequence = OabPropertyValues.UInt32(headerProperties, OabPropertyTags.AddressBookSequence);
        ContainerGuidText = OabPropertyValues.String(headerProperties, OabPropertyTags.AddressBookContainerGuid);
        HierarchicalRootDepartment = OabPropertyValues.String(headerProperties, OabPropertyTags.HierarchicalRootDepartment);
