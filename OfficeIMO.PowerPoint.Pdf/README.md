...
- pictures reuse the shared PDF JPEG/PNG image pipeline; uncropped pictures default to PowerPoint-compatible `Stretch` fitting through `PowerPointPdfSaveOptions.PictureFit`, while cropped pictures preserve authored crop-frame semantics
