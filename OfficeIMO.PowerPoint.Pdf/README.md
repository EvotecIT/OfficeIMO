...
- solid, image, and two-stop linear gradient slide backgrounds reuse the PowerPoint background snapshot API plus shared PDF shape/image primitives
...
- pictures reuse the shared PDF JPEG/PNG image pipeline
...
- unsupported slide content and shared chart drawing quality diagnostics record warnings through `PowerPointPdfSaveOptions.Warnings`
