...
public static class HtmlRenderProfileContracts {
    ...
    private static readonly IReadOnlyList<HtmlRenderProfileContract> Contracts = new[] {
        ...
        Contract(HtmlRenderIntentProfile.ScreenFullPage, "screen-full-page-v1", "Screen full page v1",
            ...
            new[] { HtmlCapabilityEvidenceIds.H4ScreenRepresentative, HtmlCapabilityEvidenceIds.H4ScreenAdvancedHeldOut },
            ...
            "The selected H4 static cases pass their declared browser-reference criteria; dynamic runtime state must be captured before rendering and broader browser equivalence is not claimed."),
        Contract(HtmlRenderIntentProfile.PrintPaged, "print-paged-v1", "Print paged v1",
            ...
            new[] { HtmlCapabilityEvidenceIds.H4PagedRepresentative, HtmlCapabilityEvidenceIds.H4PagedAdvancedHeldOut },
        ...
        Contract(HtmlRenderIntentProfile.ContinuousVector, "continuous-vector-v1", "Continuous vector v1",
            ...
            SingleSurfacePageSets, new[] { HtmlCapabilityEvidenceIds.H4ScreenRepresentative, HtmlCapabilityEvidenceIds.H4ScreenAdvancedHeldOut },
