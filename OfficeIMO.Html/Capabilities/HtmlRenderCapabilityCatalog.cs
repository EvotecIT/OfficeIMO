...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("generated-content", "Generated content", HtmlRenderCapabilityKind.Css,
            Features("content", "url() images", "mixed text and images", "attr()", "counter()", "counters()", "symbols()", "quotes", "open-quote", "close-quote", "no-open-quote", "no-close-quote", "@counter-style", "counter-reset", "counter-set", "counter-increment", "::before", "::after", "::marker", "counter(list-item)"),
            "Generates mixed secured images and quoted text, authored nested quote pairs, attributes, standard counters, functional counter styles, and document-scoped named cyclic, fixed, numeric, alphabetic, symbolic, or additive counter styles with bounded range, pad, negative, prefix, suffix, and fallback handling."),
