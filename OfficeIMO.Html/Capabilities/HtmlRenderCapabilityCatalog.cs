...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("text-flow", "Typography", HtmlRenderCapabilityKind.Css,
            Features("white-space", "nowrap", "overflow-wrap", "word-break", "letter-spacing", "word-spacing", "text-overflow:ellipsis", "line-clamp", "-webkit-line-clamp", "tab-size"),
            "Builds managed line boxes with preserved or collapsed whitespace, normal and emergency wrapping, glyph and word spacing, inherited numeric tab stops, end ellipsis, and bounded multi-line clamping."),
        ...
        Full("list-markers", "Generated content", HtmlRenderCapabilityKind.Css,
            Features("list-style-type", "decimal", "decimal-leading-zero", "lower-alpha", "upper-alpha", "lower-roman", "upper-roman", "lower-greek", "disc", "circle", "square", "quoted markers", "start", "reversed", "value"),
            "Formats standard ordered and unordered markers through the same counter-style owner used by generated content while preserving canonical HTML list ordinals."),
