...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Partial("svg", "SVG", HtmlRenderCapabilityKind.Resource,
            Features("paths", "basic shapes", "groups", "symbols", "use", "named/hex/rgb/hsl paint", "linearGradient", "radialGradient", "clipPath", "text", "tspan", "affine transforms"),
            "Maps the listed bounded SVG subset into the shared vector scene and shares CSS color parsing with HTML. Unsupported SVG content is diagnosed.",
