...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("text-flow", "Typography", HtmlRenderCapabilityKind.Css,
            Features("white-space", "nowrap", "overflow-wrap", "word-break", "text-overflow:ellipsis", "line-clamp", "-webkit-line-clamp", "tab-size"),
            "Builds managed line boxes with preserved or collapsed whitespace, normal and emergency wrapping, inherited numeric tab stops, end ellipsis, and bounded multi-line clamping."),
