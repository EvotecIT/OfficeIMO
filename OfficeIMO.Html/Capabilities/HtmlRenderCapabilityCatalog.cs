...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("web-fonts", "Fonts", HtmlRenderCapabilityKind.Resource,
            ...
            "Loads bounded policy-approved font programs, selects constrained faces by Unicode scalar range, treats variation selectors and join controls as shaping inputs, and routes logical text through measurement, complete layout, rasterization, and accessible PDF outlines. Provider-owned PDF outlines require the bounded program contract and enforce cancellation, per-run character limits, and an operation-wide path-command budget. The dependency-free core owns TrueType glyf and WOFF 1; optional providers own WOFF 2, CFF/CFF2, and variable-font instances."),
