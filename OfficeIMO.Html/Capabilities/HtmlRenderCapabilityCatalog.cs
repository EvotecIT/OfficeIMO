...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("css-borders-effects", "Color and paint", HtmlRenderCapabilityKind.Css,
            Features("border", "solid/dashed/dotted/double/groove/ridge/inset/outset", "collapsed table border conflict resolution", "border-radius", "outline", "outline-color:invert", "box-shadow", "opacity", "transform", "clip-path basic shapes", "clip-path geometry boxes"),
            "Paints the declared border styles, including two-tone three-dimensional edges and collapsed-table conflict winners, radius, deterministic backdrop-inverted outlines, shadow, opacity, two-dimensional affine transform, and basic-shape clip-path forms against margin, border, padding, or content reference boxes."),
        ...
        Full("vertical-text", "Typography", HtmlRenderCapabilityKind.Css,
            Features("writing-mode:vertical-rl", "writing-mode:vertical-lr", "writing-mode:sideways-rl", "writing-mode:sideways-lr", "text-orientation:mixed", "text-orientation:upright", "text-orientation:sideways", "logical margin/padding/border/inset/size properties", "ruby", "ruby-position", "ruby-align", "::first-letter", "::first-line"),
            "Maps logical box geometry through the active writing mode, lays out searchable vertical inline text with upright CJK and emoji plus sideways Latin glyphs, preserves logical extraction through positioned glyph groups, places scaled ruby annotations over or under horizontal and vertical bases, and applies punctuation-aware first-letter plus wrap-aware first-line styling."),
        Fallback("text-shaping-fallback", "Typography", HtmlRenderCapabilityKind.Css,
            Features("OpenType shaping outside the managed script subset", "small-caps glyph synthesis"),
        ...
        Full("paged-footnotes", "Paged media", HtmlRenderCapabilityKind.PagedMedia,
            Features("float:footnote", "inline footnotes", "block footnotes", "::footnote-call", "::footnote-marker", "counter(footnote)", "same-page reservation", "next-page deferral", "long-note continuation", "named pages", "table/flex/grid/column descendants", "PDF named destinations", "PDF Note structure"),
            "Extracts notes from supported layout containers, reserves bounded page-bottom areas, converges boundary reflow through deterministic next-page deferral, continues long notes at legal line breaks, preserves named page geometry, cascades authored call and marker styles, emits bidirectional internal PDF navigation, and tags note content in reading order. Continuous output keeps authored note content in normal flow."),
        Full("paged-fragmentation", "Paged media", HtmlRenderCapabilityKind.PagedMedia,
            Features("break-before", "break-after", "break-inside", "orphans", "widows", "box-decoration-break across page continuations", "table header repetition", "table footer repetition"),
            "Honors bounded break constraints, text widows/orphans, inline decoration continuity, legal flex/grid/column break points, and repeated table sections."),
        ...
        Full("web-fonts", "Fonts", HtmlRenderCapabilityKind.Resource,
            Features("@font-face", "font-family", "font-style", "font-weight", "unicode-range", "TrueType glyf", "WOFF 1", "single-face WOFF 2 on .NET 8+", "CFF/CFF2", "standardized variable-font instances with avar 1.0", "fallback packs"),
        ...
        Full("svg", "SVG", HtmlRenderCapabilityKind.Resource,
            Features("paths", "basic shapes", "groups", "symbols", "use", "named/hex/rgb/hsl paint", "linearGradient", "radialGradient", "pattern fill", "context-fill/context-stroke", "marker-start", "marker-mid", "marker-end", "clipPath", "mask", "mix-blend-mode", "text", "tspan", "textPath", "text-anchor", "dominant-baseline", "baseline-shift", "writing-mode", "text-orientation", "affine transforms"),
            "Maps the listed bounded SVG subset, reusable symbols, gradients, object-bounding-box or user-space vector pattern fills, reusable start/middle/end marker scenes, local clips and masks, positioned searchable text with baseline control, referenced path placement, mixed-orientation vertical glyph layout, transforms, and standard blend modes into the shared Drawing scene."),
        ...
        Fallback("svg-fallback", "SVG", HtmlRenderCapabilityKind.Resource,
            Features("unsupported SVG filters", "external references", "unsupported pattern strokes", "unsupported paint servers"),
