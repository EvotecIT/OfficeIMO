...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("css-borders-effects", "Color and paint", HtmlRenderCapabilityKind.Css,
            Features("border", "border-radius", "outline", "box-shadow", "opacity", "transform", "clip-path"),
            "Paints the declared border, radius, outline, shadow, opacity, two-dimensional affine transform, and basic-shape clip-path forms."),
        ...
        Full("web-fonts", "Fonts", HtmlRenderCapabilityKind.Resource,
            ...
            "Loads bounded policy-approved direct OpenType and WOFF 1 TrueType glyf faces, selects constrained faces by Unicode scalar range, and routes complex text through the shared shaping-provider seam."),
        Fallback("web-fonts-fallback", "Fonts", HtmlRenderCapabilityKind.Resource,
            Features("WOFF 2 transformed tables", "CFF outlines", "invalid font programs", "unavailable font sources"),
