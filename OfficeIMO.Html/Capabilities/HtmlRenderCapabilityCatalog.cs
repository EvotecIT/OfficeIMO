...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("svg", "SVG", HtmlRenderCapabilityKind.Resource,
            Features("paths", "basic shapes", "groups", "symbols", "use", "named/hex/rgb/hsl paint", "linearGradient", "radialGradient", "clipPath", "mask", "mix-blend-mode", "text", "tspan", "textPath", "text-anchor", "dominant-baseline", "baseline-shift", "writing-mode", "text-orientation", "affine transforms"),
            "Maps the listed bounded SVG subset, reusable symbols, gradients, local clips and masks, positioned searchable text with baseline control, referenced path placement, mixed-orientation vertical glyph layout, transforms, and standard blend modes into the shared Drawing scene."),
