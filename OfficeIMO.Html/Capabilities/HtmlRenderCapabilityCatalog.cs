...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Partial("generated-content", "Generated content", HtmlRenderCapabilityKind.Css,
            ...
            "Generates quoted text, attributes, standard counters, functional counter styles, and document-scoped named cyclic, fixed, numeric, alphabetic, symbolic, or additive counter styles with bounded range, pad, negative, prefix, suffix, and fallback handling. Unsupported expressions are omitted with diagnostics.",
        ...
        Full("list-markers", "Generated content", HtmlRenderCapabilityKind.Css,
            Features("list-style-type", "decimal", "decimal-leading-zero", "lower-alpha", "upper-alpha", "lower-roman", "upper-roman", "lower-greek", "cjk-decimal", "cjk-heavenly-stem", "cjk-earthly-branch", "hiragana", "hiragana-iroha", "katakana", "katakana-iroha", "full-width", "symbols()", "@counter-style", "disc", "circle", "square", "quoted markers", "start", "reversed", "value"),
            "Formats standard, bounded East Asian, functional, author-defined, and unordered markers through the same counter-style owner used by generated content while preserving canonical HTML list ordinals and custom marker affixes."),
