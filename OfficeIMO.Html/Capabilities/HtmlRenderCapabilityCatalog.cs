...
public static class HtmlRenderCapabilityCatalog {
    private static readonly IReadOnlyList<HtmlRenderCapability> Capabilities = new[] {
        ...
        Full("generated-content", "Generated content", HtmlRenderCapabilityKind.Css,
            Features("content", "url() images", "mixed text and images", "attr()", "counter()", "counters()", "symbols()", "target-text()", "target-counter(page)", "target-counter(list-item)", "leader()", "quotes", "open-quote", "close-quote", "no-open-quote", "no-close-quote", "@counter-style", "counter-reset", "counter-set", "counter-increment", "::before", "::after", "::marker", "counter(list-item)"),
