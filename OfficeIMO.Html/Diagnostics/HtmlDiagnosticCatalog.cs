...
public static class HtmlDiagnosticCatalog {
    private static readonly IReadOnlyDictionary<string, HtmlDiagnosticDefinition> Definitions = new Dictionary<string, HtmlDiagnosticDefinition>(StringComparer.OrdinalIgnoreCase) {
        ...
        [HtmlRenderDiagnosticCodes.FormFieldTransformStaticFallback] = RenderDefinition(HtmlRenderDiagnosticCodes.FormFieldTransformStaticFallback, "Interactivity", HtmlDiagnosticSeverity.Warning, "A transformed HTML form control used faithful static rendering instead of an interactive PDF widget.", "Remove the transform when PDF form interactivity is required, or keep it when visual fidelity is more important."),
