...
public static class HtmlDiagnosticCatalog {
    private static readonly IReadOnlyDictionary<string, HtmlDiagnosticDefinition> Definitions = new Dictionary<string, HtmlDiagnosticDefinition>(StringComparer.OrdinalIgnoreCase) {
        ...
        [HtmlRenderDiagnosticCodes.BorderRadiusValueUnsupported] = RenderDefinition(HtmlRenderDiagnosticCodes.BorderRadiusValueUnsupported, "PaintFidelity", HtmlDiagnosticSeverity.Warning, "A CSS border radius used square-corner fallback.", "Use one uniform circular length or equal corner declarations until asymmetric and elliptical corner geometry is enabled."),
        [HtmlRenderDiagnosticCodes.BoxShadowValueUnsupported] = RenderDefinition(HtmlRenderDiagnosticCodes.BoxShadowValueUnsupported, "PaintFidelity", HtmlDiagnosticSeverity.Warning, "A CSS box shadow was omitted.", "Use one outer shadow with two offsets, an optional non-negative blur radius, an optional zero spread, and a supported color."),
        [HtmlRenderDiagnosticCodes.BorderPaintValueUnsupported] = RenderDefinition(HtmlRenderDiagnosticCodes.BorderPaintValueUnsupported, "PaintFidelity", HtmlDiagnosticSeverity.Warning, "A CSS border paint declaration used no-border fallback.", "Use one uniform non-negative width, supported color, and solid, dashed, dotted, double, none, or hidden style."),
