...
public static partial class RtfHtmlConverterExtensions {
    ...
    public static Task<string> ToHtmlAsync(this RtfDocument document, RtfHtmlSaveOptions? options = null, CancellationToken cancellationToken = default) {
        if (document == null) {
    ...
    public static Task<byte[]> ToHtmlBytesAsync(this RtfDocument document, RtfHtmlSaveOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (document == null) {
            throw new ArgumentNullException(nameof(document));
        }
    ...
    public static Task<MemoryStream> ToHtmlMemoryStreamAsync(this RtfDocument document, RtfHtmlSaveOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (document == null) {
            throw new ArgumentNullException(nameof(document));
        }
    ...
    public static async Task SaveAsHtmlAsync(this RtfDocument document, string path, RtfHtmlSaveOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (document == null) {
            throw new ArgumentNullException(nameof(document));
        }
    ...
    public static async Task SaveAsHtmlAsync(this RtfDocument document, Stream stream, RtfHtmlSaveOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (document == null) {
            throw new ArgumentNullException(nameof(document));
        }
    ...
    public static Task<RtfDocument> LoadRtfFromHtmlAsync(this string html, RtfHtmlReadOptions? options = null, CancellationToken cancellationToken = default) {
        if (html == null) {
    ...
    public static Task<RtfDocument> LoadRtfFromHtmlAsync(this byte[] htmlBytes, RtfHtmlReadOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (htmlBytes == null) {
    ...
    public static async Task<RtfDocument> LoadRtfFromHtmlAsync(this Stream htmlStream, RtfHtmlReadOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (htmlStream == null) {
    ...
    public static async Task<string> ToRtfAsync(this string html, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<string> ToRtfAsync(this byte[] htmlBytes, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<string> ToRtfAsync(this Stream htmlStream, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<byte[]> ToRtfBytesAsync(this string html, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<byte[]> ToRtfBytesAsync(this byte[] htmlBytes, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<byte[]> ToRtfBytesAsync(this Stream htmlStream, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<MemoryStream> ToRtfMemoryStreamAsync(this string html, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<MemoryStream> ToRtfMemoryStreamAsync(this byte[] htmlBytes, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task<MemoryStream> ToRtfMemoryStreamAsync(this Stream htmlStream, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
    ...
    public static async Task SaveAsRtfAsync(this string html, string path, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (path == null) {
            throw new ArgumentNullException(nameof(path));
        }
    ...
    public static async Task SaveAsRtfAsync(this byte[] htmlBytes, string path, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
        if (path == null) {
            throw new ArgumentNullException(nameof(path));
        }
    ...
    public static async Task SaveAsRtfAsync(this Stream htmlStream, string path, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
        if (path == null) {
            throw new ArgumentNullException(nameof(path));
        }
    ...
    public static async Task SaveAsRtfAsync(this string html, Stream stream, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (stream == null) {
            throw new ArgumentNullException(nameof(stream));
        }
    ...
    public static async Task SaveAsRtfAsync(this byte[] htmlBytes, Stream stream, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
        if (stream == null) {
            throw new ArgumentNullException(nameof(stream));
        }
    ...
    public static async Task SaveAsRtfAsync(this Stream htmlStream, Stream stream, RtfHtmlReadOptions? readOptions = null, RtfWriteOptions? writeOptions = null, Encoding? htmlEncoding = null, Encoding? rtfEncoding = null, CancellationToken cancellationToken = default) {
        if (stream == null) {
            throw new ArgumentNullException(nameof(stream));
        }
