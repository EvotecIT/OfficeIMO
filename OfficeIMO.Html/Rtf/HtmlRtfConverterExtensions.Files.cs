...
public static partial class HtmlRtfConverterExtensions {
    ...
    public static RtfDocument LoadFromHtmlFile(string path, HtmlToRtfOptions? options = null, Encoding? encoding = null) {
        if (path == null) {
    ...
    public static async Task<RtfDocument> LoadFromHtmlFileAsync(string path, HtmlToRtfOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (path == null) {
            throw new ArgumentNullException(nameof(path));
        }
