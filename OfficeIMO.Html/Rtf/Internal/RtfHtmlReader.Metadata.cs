...
internal static partial class RtfHtmlReader {
    private sealed partial class ReadContext {
        ...
        private void ReadMeta(IElement token) {
            ...
            switch (name!.Trim().ToLowerInvariant()) {
                ...
                case "officeimo-rtf-document-settings":
                    ...
                    break;
                case "officeimo-rtf-fonts":
                    ApplyFontTable(RtfHtmlMetadataCodec.Decode(content));
                    break;
                ...
                case "officeimo-rtf-file-references":
                    ...
                    break;
                case "officeimo-rtf-xml-namespaces":
                    ApplyXmlNamespaces(RtfHtmlMetadataCodec.Decode(content));
                    break;
            }
        }
        ...
        private void ReadHeaderFooter(IElement token, string? encodedContent) {
            ...
            RtfDocument contentDocument = html!.ToRtfDocument();
