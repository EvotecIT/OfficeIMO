...
* Rename the table-only PDF adapters to `SaveTablesAsExcel` / `SaveTablesAsPowerPoint` and `ImportTablesToExcelDocument` / `ImportTablesToPowerPointPresentation`, with table-specific report and result types.
