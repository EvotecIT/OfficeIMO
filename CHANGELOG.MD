...
* Keep Excel and PowerPoint HTML imports detached from converter-owned streams, and support Excel PDF-table exports to write-only, non-seekable destinations.
