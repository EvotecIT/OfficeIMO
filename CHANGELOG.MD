...
* Serialize Excel floating-point cell, date, formula-cache, pivot-cache, and streaming-writer values with one invariant round-trip formatter on every target framework.
