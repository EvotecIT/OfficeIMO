...
The adapter is local and BCL-only. It does not download media, call YouTube, transcribe audio, run Whisper, or add an audio codec. Applications compose those provider capabilities explicitly outside this package.
