...
internal static class XmlReaderAdapter {
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(string path, ReaderOptions? readerOptions = null, XmlReadOptions? xmlOptions = null, CancellationToken cancellationToken = default) {
        ...
        foreach (var chunk in Read(fs, source, effectiveReaderOptions, xmlOptions, cancellationToken)) {
            yield return chunk;
        }
    }
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(Stream stream, string? sourceName = null, ReaderOptions? readerOptions = null, XmlReadOptions? xmlOptions = null, CancellationToken cancellationToken = default) {
        ...
        return Read(stream, new SourceMetadata { Path = sourcePath, SourceId = BuildSourceId(sourcePath) }, effectiveReaderOptions, options, cancellationToken);
    }

    private static IEnumerable<ReaderChunk> Read(Stream stream, SourceMetadata source, ReaderOptions effectiveReaderOptions, XmlReadOptions? xmlOptions, CancellationToken cancellationToken) {
        var options = Normalize(xmlOptions);
