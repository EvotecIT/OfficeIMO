...
public sealed class AsciiDocLosslessParsingTests {
    ...
    public void EmptySource_IsLossless() {
        AsciiDocParseResult result = AsciiDocDocument.ParseResult(string.Empty);
    ...
    public void HeadingLevels_DistinguishDocumentTitleFromSections() {
        ...
        AsciiDocHeading[] headings = AsciiDocDocument.ParseResult(source).Document.BlocksOfType<AsciiDocHeading>().ToArray();
