...
public class RtfHtmlFieldTests {
    ...
    public void RtfDocument_ToHtml_Renders_Field_Metadata() {
        ...
        RtfField roundTripField = Assert.IsType<RtfField>(Assert.Single(html.LoadFromHtml().Paragraphs).Inlines[1]);
    ...
    public void RtfDocument_ToHtml_RoundTrips_Hyperlink_Field_Target_Through_Unified_Bridge() {
        ...
        RtfField roundTripField = Assert.IsType<RtfField>(Assert.Single(html.LoadFromHtml().Paragraphs).Inlines[0]);
    ...
    public void RtfDocument_ToHtml_RoundTrips_Internal_Hyperlink_Field_SubAddress() {
        ...
        RtfField roundTripField = Assert.Single(Assert.Single(html.LoadFromHtml().Paragraphs).Inlines.OfType<RtfField>());
    ...
    public void Html_ToRtfDocument_DoesNot_Preserve_Field_Span_As_Unknown_Text() {
        ...
        RtfParagraph paragraph = Assert.Single(html.LoadFromHtml(new HtmlToRtfOptions { PreserveUnknownTagsAsText = true }).Paragraphs);
    ...
    public void Html_ToRtfDocument_Ignores_Invalid_Form_Field_Control_Names() {
        ...
        RtfField field = Assert.IsType<RtfField>(Assert.Single(html.LoadFromHtml().Paragraphs).Inlines[0]);
