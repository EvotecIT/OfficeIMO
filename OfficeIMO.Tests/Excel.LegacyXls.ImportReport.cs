...
namespace OfficeIMO.Tests {
    public partial class Excel {
        ...
        public void LegacyXls_ImportReport_ScansUnsupportedChartSheetSubstreams() {
            ...
            Assert.Equal(42, unsupportedSheet.ChartRecordCount);
            ...
            Assert.Equal(43, report.UnsupportedFeatureCount);
            Assert.Equal(42, report.PreservedFeatureRecordCount);
            Assert.Equal(1, report.UnsupportedSheetsByKind[LegacyXlsUnsupportedSheetKind.ChartSheet]);
            Assert.Equal(1, report.UnsupportedSheetsByType["0x02|ChartSheet"]);
            ...
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordCounts["ChartRecords:42"]);
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordCountsBySheet["Sheet:ChartOnly;ChartRecords:42"]);
            ...
            Assert.Equal(1, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.ChartSheet]);
            Assert.Equal(42, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(42, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(42, report.ChartRecordCount);
            ...
            Assert.Equal(41, report.ChartRecordsByContainerDepthBefore["Depth:1"]);
            Assert.Equal(41, report.ChartRecordsByContainerDepthAfter["Depth:1"]);
            ...
            Assert.Equal(40, report.ChartRecordsByContainerTransition["InsideContainer"]);
            ...
            Assert.Equal(42, report.ChartRecordsByLocation["ChartOnly"]);
            ...
            Assert.Equal(42, report.UnsupportedFeaturesByLocation["XLS-BIFF-FEATURE-CHART-UNSUPPORTED|ChartOnly"]);
