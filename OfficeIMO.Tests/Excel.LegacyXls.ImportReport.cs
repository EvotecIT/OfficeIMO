...
namespace OfficeIMO.Tests {
    public partial class Excel {
        ...
        public void LegacyXls_ImportReport_ScansUnsupportedChartSheetSubstreams() {
            ...
            Assert.Equal(37, unsupportedSheet.ChartRecordCount);
            ...
            Assert.Equal(38, report.UnsupportedFeatureCount);
            Assert.Equal(37, report.PreservedFeatureRecordCount);
            Assert.Equal(1, report.UnsupportedSheetsByKind[LegacyXlsUnsupportedSheetKind.ChartSheet]);
            Assert.Equal(1, report.UnsupportedSheetsByType["0x02|ChartSheet"]);
            ...
            Assert.Equal(1, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.ChartSheet]);
            Assert.Equal(37, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(37, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(37, report.ChartRecordCount);
            ...
            Assert.Equal(37, report.ChartRecordsByLocation["ChartOnly"]);
            ...
            Assert.Equal(37, report.UnsupportedFeaturesByLocation["XLS-BIFF-FEATURE-CHART-UNSUPPORTED|ChartOnly"]);
