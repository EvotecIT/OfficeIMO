...
namespace OfficeIMO.Tests {
    public partial class Excel {
        ...
        public void LegacyXls_ImportReport_DecodesPivotTableMetadataRecords() {
            ...
            Assert.DoesNotContain(workbook.Diagnostics, d => d.Severity == LegacyXlsDiagnosticSeverity.Error);
            Assert.Equal(20, workbook.PivotTableRecords.Count);
            Assert.Equal(20, report.PivotTableRecordCount);
            Assert.Equal(1, report.PivotTableRecordsByKind[LegacyXlsPivotTableRecordKind.View]);
            ...
            Assert.Equal(20, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.PivotTable]);
            Assert.Equal(20, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.PivotTable]);

            string markdown = report.ToMarkdown();
            Assert.Contains("Pivot table records: 20", markdown);
        ...
        public void LegacyXls_ImportReport_ScansUnsupportedChartSheetSubstreams() {
            ...
            Assert.Equal(31, unsupportedSheet.ChartRecordCount);
            Assert.Equal(2, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Container]);
            Assert.Equal(6, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Axis]);
            Assert.Equal(1, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Series]);
            Assert.Equal(8, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Formatting]);
            Assert.Equal(3, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Layout]);
            Assert.Equal(3, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.ChartType]);
            Assert.Equal(5, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Text]);
            ...
            Assert.Equal(32, report.UnsupportedFeatureCount);
            Assert.Equal(31, report.PreservedFeatureRecordCount);
            Assert.Equal(1, report.UnsupportedSheetsByKind[LegacyXlsUnsupportedSheetKind.ChartSheet]);
            Assert.Equal(1, report.UnsupportedSheetsByType["0x02|ChartSheet"]);
            ...
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordCounts["ChartRecords:31"]);
            Assert.Equal(2, report.UnsupportedChartSheetChartRecordKinds["Container"]);
            Assert.Equal(6, report.UnsupportedChartSheetChartRecordKinds["Axis"]);
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordKinds["Series"]);
            Assert.Equal(8, report.UnsupportedChartSheetChartRecordKinds["Formatting"]);
            Assert.Equal(3, report.UnsupportedChartSheetChartRecordKinds["Layout"]);
            Assert.Equal(3, report.UnsupportedChartSheetChartRecordKinds["ChartType"]);
            Assert.Equal(5, report.UnsupportedChartSheetChartRecordKinds["Text"]);
            ...
            Assert.Equal(1, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.ChartSheet]);
            Assert.Equal(31, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(31, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(31, report.ChartRecordCount);
            Assert.Equal(2, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Container]);
            Assert.Equal(6, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Axis]);
            Assert.Equal(1, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Series]);
            Assert.Equal(8, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Formatting]);
            Assert.Equal(3, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Layout]);
            Assert.Equal(3, report.ChartRecordsByKind[LegacyXlsChartRecordKind.ChartType]);
            Assert.Equal(5, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Text]);
            ...
            Assert.Equal(31, report.ChartRecordsByLocation["ChartOnly"]);
            ...
            Assert.Equal(31, report.UnsupportedFeaturesByLocation["XLS-BIFF-FEATURE-CHART-UNSUPPORTED|ChartOnly"]);
