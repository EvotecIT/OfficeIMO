...
namespace OfficeIMO.Tests {
    public partial class Excel {
        ...
        public void LegacyXls_ImportReport_ScansUnsupportedChartSheetSubstreams() {
            ...
            Assert.Equal(27, unsupportedSheet.ChartRecordCount);
            Assert.Equal(2, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Container]);
            Assert.Equal(5, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Axis]);
            ...
            Assert.Equal(28, report.UnsupportedFeatureCount);
            Assert.Equal(27, report.PreservedFeatureRecordCount);
            Assert.Equal(1, report.UnsupportedSheetsByKind[LegacyXlsUnsupportedSheetKind.ChartSheet]);
            Assert.Equal(1, report.UnsupportedSheetsByType["0x02|ChartSheet"]);
            ...
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordCounts["ChartRecords:27"]);
            Assert.Equal(2, report.UnsupportedChartSheetChartRecordKinds["Container"]);
            Assert.Equal(5, report.UnsupportedChartSheetChartRecordKinds["Axis"]);
            ...
            Assert.Equal(1, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.ChartSheet]);
            Assert.Equal(27, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(27, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(27, report.ChartRecordCount);
            Assert.Equal(2, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Container]);
            Assert.Equal(5, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Axis]);
            ...
            Assert.Equal(27, report.ChartRecordsByLocation["ChartOnly"]);
            ...
            Assert.Equal(27, report.UnsupportedFeaturesByLocation["XLS-BIFF-FEATURE-CHART-UNSUPPORTED|ChartOnly"]);
