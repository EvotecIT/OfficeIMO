...
namespace OfficeIMO.Tests {
    public partial class Excel {
        ...
        public void LegacyXls_ImportReport_DecodesPivotTableMetadataRecords() {
            ...
            Assert.DoesNotContain(workbook.Diagnostics, d => d.Severity == LegacyXlsDiagnosticSeverity.Error);
            Assert.Equal(23, workbook.PivotTableRecords.Count);
            Assert.Equal(23, report.PivotTableRecordCount);
            Assert.Equal(1, report.PivotTableRecordsByKind[LegacyXlsPivotTableRecordKind.View]);
            ...
            Assert.Equal(23, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.PivotTable]);
            Assert.Equal(23, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.PivotTable]);

            string markdown = report.ToMarkdown();
            Assert.Contains("Pivot table records: 23", markdown);
        ...
        public void LegacyXls_ImportReport_ScansUnsupportedChartSheetSubstreams() {
            ...
            Assert.Equal(40, unsupportedSheet.ChartRecordCount);
            ...
            Assert.Equal(2, unsupportedSheet.ChartRecordsByKind[LegacyXlsChartRecordKind.Series]);
            ...
            Assert.Equal(41, report.UnsupportedFeatureCount);
            Assert.Equal(40, report.PreservedFeatureRecordCount);
            Assert.Equal(1, report.UnsupportedSheetsByKind[LegacyXlsUnsupportedSheetKind.ChartSheet]);
            Assert.Equal(1, report.UnsupportedSheetsByType["0x02|ChartSheet"]);
            ...
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordCounts["ChartRecords:40"]);
            Assert.Equal(1, report.UnsupportedChartSheetChartRecordCountsBySheet["Sheet:ChartOnly;ChartRecords:40"]);
            ...
            Assert.Equal(2, report.UnsupportedChartSheetChartRecordKinds["Series"]);
            ...
            Assert.Equal(1, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.ChartSheet]);
            Assert.Equal(40, report.UnsupportedFeaturesByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(40, report.PreservedFeatureRecordsByKind[LegacyXlsUnsupportedFeatureKind.Chart]);
            Assert.Equal(40, report.ChartRecordCount);
            ...
            Assert.Equal(2, report.ChartRecordsByKind[LegacyXlsChartRecordKind.Series]);
            ...
            Assert.Equal(39, report.ChartRecordsByContainerDepthBefore["Depth:1"]);
            Assert.Equal(39, report.ChartRecordsByContainerDepthAfter["Depth:1"]);
            ...
            Assert.Equal(38, report.ChartRecordsByContainerTransition["InsideContainer"]);
            ...
            Assert.Equal(40, report.ChartRecordsByLocation["ChartOnly"]);
            ...
            Assert.Equal(40, report.UnsupportedFeaturesByLocation["XLS-BIFF-FEATURE-CHART-UNSUPPORTED|ChartOnly"]);
