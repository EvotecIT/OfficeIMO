...
public class PdfEncryptedReadTests {
    ...
    private static class EncryptedPdfFixture {
        ...
        public static byte[] CreateRevision2(string userPassword, string ownerPassword, string visibleText) {
            return CreateRevision2Core(userPassword, ownerPassword, visibleText, includeSignature: false);
        }

        public static byte[] CreateRevision2WithSignature(string userPassword, string ownerPassword, string visibleText) {
            return CreateRevision2Core(userPassword, ownerPassword, visibleText, includeSignature: true);
        }

        private static byte[] CreateRevision2Core(string userPassword, string ownerPassword, string visibleText, bool includeSignature) {
