...
internal static class MarkdigExtensionInventory {
    ...
    private static IReadOnlyList<MarkdigExtensionInventoryRow> CreateRows() => [
        ...
        Row("UseAutoLinks", "Extended autolinks", "Bare URL, www, email, and selected scheme autolinks", MarkdigExtensionInventoryStatus.Partial, "OfficeIMO has profile-sensitive bare URL/email autolinks with Markdig-style previous-character, domain-without-period, query/fragment special-character, ftp://, and tel: behavior, GFM coverage, source-backed target and angle-marker metadata, and Markdown writer preservation for parsed bare and angle autolink spelling, but broader Markdig/GFM edge breadth is not complete.", "Broaden remaining GFM/Markdig autolink edge cases before promotion."),
