...
internal static class MarkdigExtensionInventory {
    ...
    private static IReadOnlyList<MarkdigExtensionInventoryRow> CreateRows() => [
        ...
        Row("UseDefinitionLists", "Definition lists", "Definition list block syntax", MarkdigExtensionInventoryStatus.Partial, "Core parser, opt-in/profile-gated", "Remaining source-map and writer edge breadth for marker groups, lazy continuation, loose definitions, and reparsing.", "OfficeIMO has structured definition-list AST, Markdig-style colon-marker term grouping, multiple-definition parsing, source/native projection, profile-correct HTML comparison coverage, grouped Markdown writer preservation for reparsing, Markdig lazy paragraph, nested block, loose-definition, edge-continuation, and empty-marker first-continuation coverage, parsed and generated definition marker syntax tokens, native source-backed marker fields/source edits, loose-definition writer preservation, blank-separated marker-group writer preservation, tight nested-list writer preservation, and typed plus source-field multiline definition-body edits that keep continuation indentation valid for simple and marker forms, but full source-map and writer edge breadth is not closed.", "Broaden remaining Markdig definition-list source-map and writer edge cases before promotion."),
