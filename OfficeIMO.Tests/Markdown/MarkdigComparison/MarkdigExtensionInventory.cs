...
internal static class MarkdigExtensionInventory {
    ...
    private static IReadOnlyList<MarkdigExtensionInventoryRow> CreateRows() => [
        ...
        Row("UseDefinitionLists", "Definition lists", "Definition list block syntax", MarkdigExtensionInventoryStatus.Partial, "Core parser, opt-in/profile-gated", "Remaining writer and source-map edge breadth for marker groups, lazy continuation, nested blocks, and reparsing.", "OfficeIMO has structured definition-list AST, Markdig-style colon-marker term grouping, multiple-definition parsing, source/native projection, profile-correct HTML comparison coverage, grouped Markdown writer preservation for reparsing, Markdig lazy paragraph, nested block, loose-definition, edge-continuation, and empty-marker first-continuation coverage, parsed and generated definition marker syntax tokens, native source-backed marker fields/source edits, loose-definition writer preservation, and blank-separated marker-group writer preservation, but full source-map and writer edge breadth is not closed.", "Broaden remaining Markdig definition-list writer and source-map edge cases before promotion."),
