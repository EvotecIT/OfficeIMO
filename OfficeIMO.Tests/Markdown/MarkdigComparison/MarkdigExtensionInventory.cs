...
internal static class MarkdigExtensionInventory {
    ...
    private static IReadOnlyList<MarkdigExtensionInventoryRow> CreateRows() => [
        ...
        Row("UsePipeTables", "Pipe tables", "GFM pipe table syntax", MarkdigExtensionInventoryStatus.Partial, "OfficeIMO has GFM pipe-table parsing, AST/source mapping, and tracked GFM fixtures, but broader table corpus coverage is still open.", "Expand GFM/Markdig table fixtures for malformed delimiters and containers."),
        ...
        Row("UseTaskLists", "Task lists", "GFM task-list markers", MarkdigExtensionInventoryStatus.Partial, "OfficeIMO has task-list parsing, AST flags, marker source spans, and tracked GFM fixtures.", "Broaden nested/task marker corpus and writer/source-edit proof."),
