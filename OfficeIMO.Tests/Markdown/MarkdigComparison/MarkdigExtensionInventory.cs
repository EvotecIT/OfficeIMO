...
internal static class MarkdigExtensionInventory {
    ...
    private static IReadOnlyList<MarkdigExtensionInventoryRow> CreateRows() => [
        ...
        Row("UseDefinitionLists", "Definition lists", "Definition list block syntax", MarkdigExtensionInventoryStatus.Partial, "OfficeIMO has structured definition-list AST, Markdig-style colon-marker term grouping, multiple-definition parsing, source/native projection, HTML comparison coverage, grouped Markdown writer preservation for reparsing, and Markdig lazy paragraph continuation coverage, but broader nested and edge-continuation breadth is not closed.", "Broaden remaining Markdig definition-list nested-block and edge-continuation cases before promotion."),
