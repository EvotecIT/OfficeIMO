...
internal static class MarkdigExtensionInventory {
    ...
    private static IReadOnlyList<MarkdigExtensionInventoryRow> CreateRows() => [
        ...
        Row("UseAutoLinks", "Extended autolinks", "Bare URL, www, and email autolinks", MarkdigExtensionInventoryStatus.Partial, "OfficeIMO has profile-sensitive bare URL/email autolinks with Markdig-style previous-character and domain-without-period options plus GFM coverage, but broader Markdig/GFM edge breadth is not complete.", "Broaden GFM/Markdig autolink cases and finish source/writer evidence before promotion."),
