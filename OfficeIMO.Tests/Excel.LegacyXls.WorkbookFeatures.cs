...
namespace OfficeIMO.Tests {
    public partial class Excel {
        ...
        public void LegacyXls_Load_ImportsWorkbookMetadataRecords() {
            ...
            Assert.Equal(24, workbook.MetadataRecords.Count);
            Assert.Equal(5, workbook.FutureMetadataRecords.Count);
            ...
            Assert.Equal((ushort)0x088b, compat12.HeaderRecordType);
            Assert.Equal((ushort)0x0001, compat12.HeaderFlags);
            Assert.Equal(2, compat12.BodyByteCount);
            ...
            Assert.Equal(2, sheetCompat12.BodyByteCount);
            Assert.Equal(24, result.ImportReport.WorkbookMetadataRecordCount);
            Assert.Equal(5, result.ImportReport.WorkbookFutureMetadataRecordCount);
            ...
            Assert.Equal(4, result.ImportReport.WorkbookFutureMetadataRecordsByHeaderState["MatchingFutureHeader"]);
            ...
            Assert.Equal(1, result.ImportReport.WorkbookFutureMetadataRecordsByHeaderFlags["Flags:0x0001"]);
            Assert.Equal(2, result.ImportReport.WorkbookFutureMetadataRecordsByPayloadLength["Bytes:14"]);
            Assert.Equal(2, result.ImportReport.WorkbookFutureMetadataRecordsByBodyByteCount["Bytes:2"]);
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsByKind["Compatibility12"]);
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsBySheet["Metadata"]);
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsBySheetAndKind["Metadata|Compatibility12"]);
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsByRecordType["0x088B"]);
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsByRecordName["Compat12"]);
            ...
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsByPayloadLength["Bytes:14"]);
            Assert.Equal(1, result.ImportReport.WorksheetFutureMetadataRecordsByBodyByteCount["Bytes:2"]);
            ...
            Assert.Contains("Workbook metadata records: 24", result.ImportReport.ToMarkdown());
            Assert.Contains("Workbook future metadata records: 5", result.ImportReport.ToMarkdown());
