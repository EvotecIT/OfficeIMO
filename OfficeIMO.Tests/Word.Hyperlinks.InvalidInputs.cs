...
namespace OfficeIMO.Tests {
    public partial class Word {
        ...
        public void Test_AddHyperLink_InvalidTextThrows() {
            ...
            Assert.Throws<ArgumentNullException>(() => document.AddHyperLink(null!, new Uri("https://example.com")));
            ...
            Assert.Throws<ArgumentNullException>(() => document.AddHyperLink(null!, "Bookmark"));
        ...
        public void Test_AddHyperLink_InvalidUriOrAnchorThrows() {
            using var document = WordDocument.Create();
            Assert.Throws<ArgumentNullException>(() => document.AddHyperLink("Test", (Uri)null!));
            Assert.Throws<ArgumentNullException>(() => document.AddHyperLink("Test", (string)null!));
