...
public static partial class DocumentReaderPdfExtensions {
    ...
    /// </summary>
    public static string ReadPdfDocumentJson(string pdfPath, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, bool indented = false, CancellationToken cancellationToken = default) {
        OfficeDocumentReadResult result = ReadPdfDocument(pdfPath, readerOptions, pdfOptions, cancellationToken);
    ...
    /// </summary>
    public static string ReadPdfDocumentJson(Stream pdfStream, string? sourceName = null, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, bool indented = false, CancellationToken cancellationToken = default) {
        OfficeDocumentReadResult result = ReadPdfDocument(pdfStream, sourceName, readerOptions, pdfOptions, cancellationToken);
        return OfficeDocumentReadResultJson.Serialize(result, indented);
    }
    ...
    public static string ReadPdfDocumentJson(PdfLogicalDocument document, string sourceName = "document.pdf", ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, bool indented = false, CancellationToken cancellationToken = default) {
        OfficeDocumentReadResult result = ReadPdfDocument(document, sourceName, readerOptions, pdfOptions, cancellationToken);
        return OfficeDocumentReadResultJson.Serialize(result, indented);
    }
    ...
    /// </summary>
    public static IReadOnlyList<ReaderTable> ReadPdfTables(string pdfPath, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, CancellationToken cancellationToken = default) {
        return DocumentReader.ExtractTables(ReadPdfFile(pdfPath, readerOptions, pdfOptions, cancellationToken), cancellationToken);
    }

    /// <summary>
    /// Reads a PDF stream and returns logical tables in source order.
    /// </summary>
    public static IReadOnlyList<ReaderTable> ReadPdfTables(Stream pdfStream, string? sourceName = null, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, CancellationToken cancellationToken = default) {
        return DocumentReader.ExtractTables(ReadPdf(pdfStream, sourceName, readerOptions, pdfOptions, cancellationToken), cancellationToken);
    }
    ...
    public static IReadOnlyList<ReaderTable> ReadPdfTables(PdfLogicalDocument document, string sourceName = "document.pdf", ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, CancellationToken cancellationToken = default) {
        return DocumentReader.ExtractTables(ReadPdf(document, sourceName, readerOptions, pdfOptions, cancellationToken), cancellationToken);
    }

    /// <summary>
    /// Reads a PDF file and returns logical table export payloads in source order.
    /// </summary>
    public static IReadOnlyList<ReaderTableExportBundle> ReadPdfTableExports(string pdfPath, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, bool indentedJson = false, CancellationToken cancellationToken = default) {
        return DocumentReader.ExportTables(ReadPdfTables(pdfPath, readerOptions, pdfOptions, cancellationToken), indentedJson, cancellationToken);
    }
    ...
    /// </summary>
    public static IReadOnlyList<ReaderTableExportBundle> ReadPdfTableExports(PdfLogicalDocument document, string sourceName = "document.pdf", ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, bool indentedJson = false, CancellationToken cancellationToken = default) {
        return DocumentReader.ExportTables(ReadPdfTables(document, sourceName, readerOptions, pdfOptions, cancellationToken), indentedJson, cancellationToken);
    }

    /// <summary>
    /// Reads a PDF file and returns the shared OfficeIMO read result envelope.
    /// </summary>
    public static OfficeDocumentReadResult ReadPdfDocument(string pdfPath, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, CancellationToken cancellationToken = default) {
    ...
    /// </summary>
    public static OfficeDocumentReadResult ReadPdfDocument(Stream pdfStream, string? sourceName = null, ReaderOptions? readerOptions = null, ReaderPdfOptions? pdfOptions = null, CancellationToken cancellationToken = default) {
