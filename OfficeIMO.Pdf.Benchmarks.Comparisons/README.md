...
The split, merge, and page-selection suites use 5-, 20-, 100-, and 500-page source scales. At 500 pages, selection extracts 125 pages in reverse order, merge combines 50 ten-page documents, and split emits either 500 single-page files or 25-page bundles. Every scale keeps the same source and output validation for each engine.
