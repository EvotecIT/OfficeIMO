...
- Pages recovers rich paragraphs, page layout, section-specific headers/footers, positioned and sized accessible rich-text boxes, images, tables, and merges for editable Word projection.
...
- Keynote recovers slide size, order and names, positioned rich text with explicit inline breaks and complete list labels, shape/run and presenter-note hyperlinks, notes, images, tables, and merges for editable PowerPoint projection.
