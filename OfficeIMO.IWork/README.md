...
- Keynote recovers slide size and order, positioned rich text, shape/run and presenter-note hyperlinks, notes, images, tables, and merges for editable PowerPoint projection.
