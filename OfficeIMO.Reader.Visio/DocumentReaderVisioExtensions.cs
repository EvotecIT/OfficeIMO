...
/// <summary>
/// Visio ingestion adapter for <see cref="DocumentReader"/>.
/// </summary>
public static partial class DocumentReaderVisioExtensions {
    /// <summary>
    /// Reads a Visio file and emits normalized page chunks.
    /// </summary>
    public static IEnumerable<ReaderChunk> ReadVisioFile(string visioPath, ReaderOptions? readerOptions = null, ReaderVisioOptions? visioOptions = null, CancellationToken cancellationToken = default) {
        ...
        foreach (var chunk in ReadVisio(document, source, effectiveReaderOptions, cancellationToken)) {
            yield return chunk;
        }
    }
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> ReadVisio(Stream visioStream, string? sourceName = null, ReaderOptions? readerOptions = null, ReaderVisioOptions? visioOptions = null, CancellationToken cancellationToken = default) {
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> ReadVisio(VisioDocument document, string sourceName = "document.vsdx", ReaderOptions? readerOptions = null, ReaderVisioOptions? visioOptions = null, CancellationToken cancellationToken = default) {
    ...
    private static IEnumerable<ReaderChunk> ReadVisio(VisioDocument document, SourceMetadata source, ReaderOptions readerOptions, CancellationToken cancellationToken) {
