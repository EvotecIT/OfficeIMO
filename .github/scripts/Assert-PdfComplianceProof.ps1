...
$measuredPaths = @(
    ...
    'OfficeIMO.Mhtml.Pdf',
    'OfficeIMO.Invoicing',
    'OfficeIMO.Invoicing.Tests',
    'OfficeIMO.Invoicing.Pdf',
    'OfficeIMO.Invoicing.Pdf.Tests',
    'OfficeIMO.SharedSource',
