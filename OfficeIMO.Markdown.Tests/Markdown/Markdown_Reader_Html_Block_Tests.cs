...
namespace OfficeIMO.Tests.MarkdownSuite {
    public class Markdown_Reader_Html_Block_Tests {
        ...
        public void CommonMark_Profile_Preserves_Inline_Raw_Html_Constructs() {
            ...
            string html = OfficeIMO.Markdown.MarkdownReader.Parse(md, MarkdownReaderOptions.CreateCommonMarkProfile())
        ...
        public void OfficeIMO_Profile_Rejects_Malformed_Type6_Block_Html_Starts() {
            ...
            var doc = OfficeIMO.Markdown.MarkdownReader.Parse(md, MarkdownReaderOptions.CreateOfficeIMOProfile());
