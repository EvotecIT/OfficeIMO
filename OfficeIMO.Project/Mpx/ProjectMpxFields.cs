...
internal static partial class ProjectMpxFields {
    ...
    internal static readonly Field<ProjectTask>[] Tasks = {
        ...
        new Field<ProjectTask>(30, "Cost", "Cost", (t, s, v) => t.Cost = v.Money(s), t => ProjectMpxValues.Text(t.Cost)),
        new Field<ProjectTask>(32, "Actual Cost", "ActualCost", (t, s, v) => t.ActualCost = v.Money(s), t => ProjectMpxValues.Text(t.ActualCost)),
        new Field<ProjectTask>(33, "Remaining Cost", "RemainingCost", (t, s, v) => t.RemainingCost = v.Money(s), t => ProjectMpxValues.Text(t.RemainingCost)),
        new Field<ProjectTask>(35, "Fixed Cost", "FixedCost", (t, s, v) => t.FixedCost = v.Money(s), t => ProjectMpxValues.Text(t.FixedCost)),
    ...
    internal static readonly Field<ProjectResource>[] Resources = {
        ...
        new Field<ProjectResource>(30, "Cost", "Cost", (t, s, v) => t.Cost = v.Money(s), t => ProjectMpxValues.Text(t.Cost)),
        new Field<ProjectResource>(32, "Actual Cost", "ActualCost", (t, s, v) => t.ActualCost = v.Money(s), t => ProjectMpxValues.Text(t.ActualCost)),
        new Field<ProjectResource>(33, "Remaining Cost", "RemainingCost", (t, s, v) => t.RemainingCost = v.Money(s), t => ProjectMpxValues.Text(t.RemainingCost)),
        ...
        new Field<ProjectResource>(44, "Cost Per Use", "CostPerUse", (t, s, v) => t.CostPerUse = v.Money(s), t => ProjectMpxValues.Text(t.CostPerUse)),
    };
