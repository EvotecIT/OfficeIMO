...
public sealed class ProjectDependency : ProjectObject {
    ...
    public decimal? LagPercent { get => _lagPercent; set { if (value != null && _lag != null) throw new InvalidOperationException("Clear duration lag before setting percentage lag."); Set(ref _lagPercent, value, true); } }
