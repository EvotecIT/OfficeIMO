...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadPaymentAccounts(byte[] data, out CiiPaymentAccountEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiPaymentAccountEvidence(
                    hasPaymentMeans,
                    hasCreditorAccount,
                    hasAccountId,
                    hasIbanId,
