...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadLineAmountConsistency(byte[] data, out CiiLineAmountConsistencyEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiLineAmountConsistencyEvidence(
                    hasLineItem,
                    hasBilledQuantity,
