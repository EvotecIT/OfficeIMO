...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadTaxTotalConsistency(byte[] data, out CiiTaxTotalConsistencyEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiTaxTotalConsistencyEvidence(
