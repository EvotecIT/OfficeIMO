...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadTaxBreakdown(byte[] data, out CiiTaxBreakdownEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiTaxBreakdownEvidence(hasApplicableTradeTax, hasTypeCode && missingTypeCodeBreakdowns.Count == 0, hasCategoryCode && missingCategoryCodeBreakdowns.Count == 0, hasRateApplicablePercent, hasBasisAmount, hasCalculatedAmount, typeCodes, missingTypeCodeBreakdowns, missingCategoryCodeBreakdowns);
                diagnostic = null;
                return true;
            }
