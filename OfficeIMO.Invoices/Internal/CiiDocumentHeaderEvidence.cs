...
internal sealed class CiiDocumentHeaderEvidence {
    internal CiiDocumentHeaderEvidence(string? id, string? typeCode, string? issueDateTime, bool hasSupplyChainTradeTransaction) {
