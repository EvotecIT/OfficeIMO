...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadTaxCategoryCodes(byte[] data, out CiiTaxCategoryCodeEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiTaxCategoryCodeEvidence(
