...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadLinePricing(byte[] data, out CiiLinePricingEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiLinePricingEvidence(hasLineItem, hasAgreement, hasProductTradePrice, hasPriceChargeAmount, missingLinePricingFields);
                diagnostic = null;
                return true;
            }
