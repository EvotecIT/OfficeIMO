...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadAllowanceChargeReasons(byte[] data, out CiiAllowanceChargeReasonEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiAllowanceChargeReasonEvidence(missingAllowanceReasons, missingChargeReasons);
                diagnostic = null;
                return true;
            }
