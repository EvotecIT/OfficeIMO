...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadTaxCategoryConsistency(byte[] data, out CiiTaxCategoryConsistencyEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiTaxCategoryConsistencyEvidence(
