...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryRead(byte[] data, out CiiDocumentHeaderEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiDocumentHeaderEvidence(documentId, typeCode, issueDateTime, hasTradeTransaction);
                diagnostic = null;
                return true;
            }
    ...
    internal static bool TryReadTradeTransaction(byte[] data, out CiiTradeTransactionEvidence? evidence, out string? diagnostic) {
        if (data == null) throw new ArgumentNullException(nameof(data), "Invoice XML is required.");
        evidence = null;
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiTradeTransactionEvidence(false, false, false, false, false, false, false);
                diagnostic = null;
                return true;
            }
        } catch (System.Xml.XmlException ex) {
    ...
    internal static bool TryReadLineItems(byte[] data, out CiiLineItemEvidence? evidence, out string? diagnostic) {
        if (data == null) throw new ArgumentNullException(nameof(data), "Invoice XML is required.");
        evidence = null;
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiLineItemEvidence(hasLineItem, hasLineId, hasProductName, hasBilledQuantity, hasBilledQuantityUnitCode, hasLineTotalAmount, missingLineItemFields.ToArray());
                diagnostic = null;
                return true;
            }
        } catch (System.Xml.XmlException ex) {
    ...
    internal static bool TryReadPartyIdentification(byte[] data, out CiiPartyIdentificationEvidence? evidence, out string? diagnostic) {
        if (data == null) throw new ArgumentNullException(nameof(data), "Invoice XML is required.");
        evidence = null;
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiPartyIdentificationEvidence(hasSellerName, hasSellerCountryId, hasBuyerName, hasBuyerCountryId);
                diagnostic = null;
                return true;
            }
        } catch (System.Xml.XmlException ex) {
    ...
    internal static bool TryReadSettlementSummary(byte[] data, out CiiSettlementSummaryEvidence? evidence, out string? diagnostic) {
        if (data == null) throw new ArgumentNullException(nameof(data), "Invoice XML is required.");
        evidence = null;
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiSettlementSummaryEvidence(hasSettlement, hasCurrencyCode, hasTradeTax, hasTaxBasisTotalAmount, hasTaxTotalAmount);
                diagnostic = null;
                return true;
            }
        } catch (System.Xml.XmlException ex) {
    ...
    internal static bool TryReadAmountConsistency(byte[] data, out CiiAmountConsistencyEvidence? evidence, out string? diagnostic) {
        if (data == null) throw new ArgumentNullException(nameof(data), "Invoice XML is required.");
        evidence = null;
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiAmountConsistencyEvidence(
    ...
    internal static bool TryReadPaymentInstructions(byte[] data, out CiiPaymentInstructionEvidence? evidence, out string? diagnostic) {
        if (data == null) throw new ArgumentNullException(nameof(data), "Invoice XML is required.");
        evidence = null;
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiPaymentInstructionEvidence(
                    hasPaymentMeans,
                    hasTypeCode,
                    hasCreditorAccount,
    ...
    private static CiiTradeTransactionEvidence ReadTradeTransaction(System.Xml.XmlReader reader) {
        ...
        if (reader.IsEmptyElement) {
            return new CiiTradeTransactionEvidence(true, hasAgreement, hasSeller, hasBuyer, hasSettlement, hasSummation, hasAmount);
        }
