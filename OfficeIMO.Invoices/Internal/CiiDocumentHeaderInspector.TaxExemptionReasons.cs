...
internal static partial class CiiDocumentHeaderInspector {
    internal static bool TryReadTaxExemptionReasons(byte[] data, out CiiTaxExemptionReasonEvidence? evidence, out string? diagnostic) {
        ...
        try {
            ...
            using (var reader = System.Xml.XmlReader.Create(stream, new System.Xml.XmlReaderSettings {
                ...
                evidence = new CiiTaxExemptionReasonEvidence(
