...
namespace OfficeImo
{
    public class Class1
    {
        public static void RemoveHeaders(Document document, MainDocumentPart docPart)
        {
        ...
        public static void RemoveFooters(Document document, MainDocumentPart docPart)
        {
        ...
        public static void RemoveHeadersAndFooters(string filename)
        {
            ...
            using (WordprocessingDocument doc = WordprocessingDocument.Open(filename, true))
            {
                ...
                RemoveHeaders(document, docPart);
                RemoveFooters(document, docPart);
