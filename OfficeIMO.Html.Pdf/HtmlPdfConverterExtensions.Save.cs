...
public static partial class HtmlPdfConverterExtensions {
    ...
    public static PdfCore.PdfSaveResult SaveAsPdf(this HtmlConversionDocument document, string path, HtmlToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdf(this HtmlConversionDocument document, Stream pdfStream, HtmlToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this HtmlConversionDocument document, string path, HtmlToPdfOptions? options = null) {
        try {
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this HtmlConversionDocument document, Stream pdfStream, HtmlToPdfOptions? options = null) {
        try {
            return document.ToPdfDocumentResult(options).SaveResult(pdfStream);
        } catch (Exception exception) {
