...
public static class HtmlPdfProfileContracts {
    private static readonly IReadOnlyList<HtmlPdfProfileContract> Contracts = new ReadOnlyCollection<HtmlPdfProfileContract>(new[] {
        ...
        new HtmlPdfProfileContract(
            ...
            new[] { "cascade-and-inheritance", "custom-properties", "print-media", "font-and-color", "margin-padding-border-background", "width-height", "text-alignment", "generic-page-size-margin", "first-left-right-page-margin-content", "page-counters", "page-break-before-after", "widows-orphans" },
