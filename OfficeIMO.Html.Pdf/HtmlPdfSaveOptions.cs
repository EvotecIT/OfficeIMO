...
public sealed class HtmlPdfSaveOptions : HtmlRenderOptions {
    ...
    /// <summary>
    /// Maximum UTF-16 characters expanded into provider-owned vector outlines for one rendered text run.
    ...
    /// <summary>
    /// Maximum path commands generated by provider-owned text outlines across one PDF conversion.
    /// </summary>
