...
internal sealed class ProviderSaveDialog : Window {
    internal ProviderSaveDialog(string name, IStudioLocalizer localizer) {
        ...
        Content = new StackPanel {
            ...
            Children = {
                ...
                new TextBlock { Text = localizer.Get("Dialog.ProviderSaveDescription"), TextWrapping = TextWrapping.Wrap },
