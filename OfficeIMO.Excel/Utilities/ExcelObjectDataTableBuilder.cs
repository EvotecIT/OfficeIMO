...
namespace OfficeIMO.Excel {
    ...
    /// </summary>
    public static class ExcelObjectDataTableBuilder {
        /// <summary>
        ...
        public static DataTable FromObjects(IEnumerable<object?> items, string tableName = "Data", ExcelObjectDataTableBuilderOptions? options = null) {
            if (items == null) {
                throw new ArgumentNullException(nameof(items));
            }

            options ??= new ExcelObjectDataTableBuilderOptions();
        ...
        private sealed class ObjectRowProjector {
            ...
            private readonly ExcelObjectDataTableBuilderOptions _options;
            ...
            private ObjectRowProjector(string[] columns, ObjectValueGetter[]? getters, Type? sourceType, bool createOrdinalColumnIndexes, ExcelObjectDataTableBuilderOptions options) {
                _columns = columns;
            ...
            internal static ObjectRowProjector Create(object first, IReadOnlyList<string> columns, ExcelObjectDataTableBuilderOptions options) {
            ...
            private static object? NormalizeCellValue(object? value, ExcelObjectDataTableBuilderOptions options) {
