...
namespace OfficeIMO.Excel.LegacyXls.Biff {
    internal static class BiffWorkbookMetadataReader {
        internal static bool TryRead(BiffRecord record, LegacyXlsWorkbook workbook, List<LegacyXlsImportDiagnostic> diagnostics) {
            if (BiffFutureMetadataReader.TryCreateWorkbookRecord(record, out LegacyXlsWorkbookFutureMetadataRecord? futureMetadataRecord)) {
                workbook.AddFutureMetadataRecord(futureMetadataRecord!);
                return true;
            }
