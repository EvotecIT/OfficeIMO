    ...
    internal sealed partial class LegacyXlsTabularDataReader {
        ...
        private bool TryDiscoverIndexed(
            ...
            for (int blockIndex = 0; blockIndex < dbCellCount; blockIndex++) {
                ...
                if (dbCellOffset <= lastDbCellEnd) return false;
                ...
                if (rowCount <= 0 || rowCount > MaximumIndexedRowsPerBlock) return false;
                ...
                for (int rowIndex = 0; rowIndex < rowCount; rowIndex++) {
                    ...
                    if (row <= previousRow
                        || row < dimensionFirstRow
                        || row >= dimensionRowAfterLast) {
                        return false;
                    }
            ...
            if (previousRow < 0 || lastDbCellEnd < 0) return false;
