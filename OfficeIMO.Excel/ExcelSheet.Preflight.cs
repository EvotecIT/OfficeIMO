    ...
    public partial class ExcelSheet
    {
        ...
        internal void Preflight()
        {
            WriteLock(() =>
            {
                ...
                {
                    try { var _ = _worksheetPart.GetPartById(dId); }
                    catch { ws.RemoveChild(drawing); }
                }
                ...
                {
                    try { var _ = _worksheetPart.GetPartById(lId); }
                    catch { ws.RemoveChild(legacy); }
                }
                ...
                if (parts != null)
                {
                    ...
                    foreach (var tp in parts.Elements<TablePart>().ToList())
                    {
                        ...
                        try { var _ = _worksheetPart.GetPartById(id); }
                        catch { tp.Remove(); }
                    }
