    ...
    public partial class ExcelSheet {
        ...
        private IReadOnlyList<WorkbookConnectionRoot> LoadWorkbookConnectionRoots(
            ...
            foreach (IdPartPair pair in WorkbookPartRoot.Parts) {
                ...
                if (part is ConnectionsPart nativePart) {
                    if (nativePart.Connections != null) {
                        result.Add(new WorkbookConnectionRoot(part, nativePart.Connections));
                    }
                    continue;
                }
                ...
                try {
                    result.Add(new WorkbookConnectionRoot(part, new Connections(xml)));
