...
namespace OfficeIMO.Excel {
    ...
    /// </summary>
    public sealed class ExcelColumnStyleByHeaderBuilder {
        private readonly ExcelSheet _sheet;
        private readonly int _colIndex;
        private readonly int _startRow;
        private readonly int _endRow;

        internal ExcelColumnStyleByHeaderBuilder(ExcelSheet sheet, int colIndex, int startRow, int endRow) {
            _sheet = sheet;
            _colIndex = colIndex;
            _startRow = startRow;
            _endRow = endRow;
        ...
        private ExcelColumnStyleByHeaderBuilder ApplyFormat(string numberFormat) {
        ...
        public ExcelColumnStyleByHeaderBuilder Number(int decimals = 0)
            => ApplyFormat(ExcelNumberFormats.Get(ExcelNumberPreset.Decimal, decimals));

        /// <summary>
        /// Applies an integer number format.
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder Integer() => ApplyFormat(ExcelNumberFormats.Get(ExcelNumberPreset.Integer));

        /// <summary>
        /// Applies a percentage format.
        /// </summary>
        /// <param name="decimals">Number of decimal places.</param>
        public ExcelColumnStyleByHeaderBuilder Percent(int decimals = 0)
        ...
        public ExcelColumnStyleByHeaderBuilder Currency(int decimals = 2, CultureInfo? culture = null)
        ...
        public ExcelColumnStyleByHeaderBuilder Date(string pattern = "yyyy-mm-dd") => ApplyFormat(pattern);

        /// <summary>
        /// Applies a date and time format using the provided pattern.
        /// </summary>
        /// <param name="pattern">DateTime format pattern.</param>
        public ExcelColumnStyleByHeaderBuilder DateTime(string pattern = "yyyy-mm-dd hh:mm:ss") => ApplyFormat(pattern);

        /// <summary>
        /// Applies a time format.
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder Time() => ApplyFormat(ExcelNumberFormats.Get(ExcelNumberPreset.Time));

        /// <summary>
        /// Applies a duration format in hours.
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder DurationHours() => ApplyFormat(ExcelNumberFormats.Get(ExcelNumberPreset.DurationHours));

        /// <summary>
        /// Applies a text format.
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder Text() => ApplyFormat(ExcelNumberFormats.Get(ExcelNumberPreset.Text));

        /// <summary>
        /// Applies a custom number format string.
        /// </summary>
        /// <param name="format">Number format pattern.</param>
        public ExcelColumnStyleByHeaderBuilder NumberFormat(string format) => ApplyFormat(format);

        /// <summary>
        /// Makes all cells in the column bold.
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder Bold() {
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder Background(string hexColor) {
            for (int r = _startRow; r <= _endRow; r++)
        ...
        public ExcelColumnStyleByHeaderBuilder Background(OfficeIMO.Drawing.OfficeColor color) {
            for (int r = _startRow; r <= _endRow; r++)
        ...
        public ExcelColumnStyleByHeaderBuilder AlignLeft() {
            for (int r = _startRow; r <= _endRow; r++)
        ...
        public ExcelColumnStyleByHeaderBuilder AlignCenter() {
            for (int r = _startRow; r <= _endRow; r++)
        ...
        public ExcelColumnStyleByHeaderBuilder AlignRight() {
            for (int r = _startRow; r <= _endRow; r++)
        ...
        public ExcelColumnStyleByHeaderBuilder FontColor(string hexColor) {
            for (int r = _startRow; r <= _endRow; r++)
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder FontColorByTextMap(System.Collections.Generic.IDictionary<string, string> map, bool caseInsensitive = true) {
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder BackgroundWhenTextEquals(string text, string hexColor, bool caseInsensitive = true) {
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder BackgroundByTextMap(System.Collections.Generic.IDictionary<string, string> map, bool caseInsensitive = true) {
            if (map == null || map.Count == 0) return this;
            var dict = caseInsensitive ? new System.Collections.Generic.Dictionary<string, string>(map, System.StringComparer.OrdinalIgnoreCase)
                                       : new System.Collections.Generic.Dictionary<string, string>(map);
            for (int r = _startRow; r <= _endRow; r++) {
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder BackgroundByTextMap(System.Collections.Generic.IDictionary<string, OfficeIMO.Drawing.OfficeColor> map, bool caseInsensitive = true) {
            if (map == null || map.Count == 0) return this;
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder BoldWhenTextEquals(string text, bool caseInsensitive = true) {
        ...
        /// </summary>
        public ExcelColumnStyleByHeaderBuilder BoldByTextSet(System.Collections.Generic.ISet<string> values, bool caseInsensitive = true) {
