...
namespace OfficeIMO.Excel {
    ...
    internal static class ExcelFormulaReferenceRewriter {
        ...
        private const string SharedFormulaReferencePattern =
        ...
        internal static readonly Regex SharedFormulaReferenceRegex = new Regex(
            SharedFormulaReferencePattern,
            RegexOptions.IgnoreCase | RegexOptions.Compiled | RegexOptions.CultureInvariant,
            SharedFormulaRegexTimeout);

        internal static readonly Regex SharedFormulaReferenceAtCursorRegex = new Regex(
            @"\G(?:" + SharedFormulaReferencePattern + ")",
            RegexOptions.IgnoreCase | RegexOptions.Compiled | RegexOptions.CultureInvariant,
            SharedFormulaRegexTimeout);
