...
/// <summary>Runtime and language evidence captured when a Tesseract OCR session is created.</summary>
public sealed class TesseractOcrRuntimeEvidence {
    internal TesseractOcrRuntimeEvidence(
