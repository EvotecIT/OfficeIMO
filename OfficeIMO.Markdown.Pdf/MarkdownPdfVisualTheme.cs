...
/// </summary>
public sealed class MarkdownPdfVisualTheme {
    ...
    public static MarkdownPdfVisualTheme Create(MarkdownPdfThemeKind kind) {
        switch (kind) {
            case MarkdownPdfThemeKind.Plain:
                return Plain();
            case MarkdownPdfThemeKind.WordLike:
                return WordLike();
            case MarkdownPdfThemeKind.TechnicalDocument:
                return TechnicalDocument();
            case MarkdownPdfThemeKind.GitHubLike:
                return GitHubLike();
            case MarkdownPdfThemeKind.Compact:
                return Compact();
            case MarkdownPdfThemeKind.Report:
                return Report();
            default:
    ...
    /// <summary>Tries to create a built-in profile from a front-matter or API name.</summary>
    public static bool TryCreate(string? name, out MarkdownPdfVisualTheme? theme) {
        theme = null;
    ...
    public static MarkdownPdfVisualTheme Plain() => new MarkdownPdfVisualTheme {
        Name = "Plain",
    ...
    public static MarkdownPdfVisualTheme WordLike() {
        MarkdownPdfVisualTheme theme = Plain();
        theme.Name = "WordLike";
    ...
    public static MarkdownPdfVisualTheme TechnicalDocument() => new MarkdownPdfVisualTheme {
    ...
    public static MarkdownPdfVisualTheme GitHubLike() => new MarkdownPdfVisualTheme {
        Name = "GitHubLike",
    ...
    public static MarkdownPdfVisualTheme Compact() => new MarkdownPdfVisualTheme {
        Name = "Compact",
    ...
    public static MarkdownPdfVisualTheme Report() => new MarkdownPdfVisualTheme {
        Name = "Report",
    ...
    public MarkdownPdfVisualTheme Clone() => new MarkdownPdfVisualTheme {
        Name = Name,
