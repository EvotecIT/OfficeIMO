...
public partial class PdfFormFillerTests {
    ...
    private static byte[] BuildPasswordTextWidgetWithoutAppearancePdf() {
        string pdf = string.Join("\n", new[] {
            "%PDF-1.4",
            "1 0 obj",
            "<< /Type /Catalog /Pages 2 0 R /AcroForm 5 0 R >>",
            ...
            "endobj",
            "7 0 obj",
            "<< /FT /Tx /T (Password) /V (Secret42) /Ff 8192 /Kids [8 0 R] >>",
            "endobj",
            "8 0 obj",
            "<< /Type /Annot /Subtype /Widget /Parent 7 0 R /Rect [20 100 180 120] /F 4 >>",
            "endobj",
    ...
    private static byte[] BuildTextWidgetFormPdfWithInheritedPageResources() {
        string existing = "BT /F1 12 Tf 20 150 Td (Inherited form page text) Tj ET";
        string pdf = string.Join("\n", new[] {
            "%PDF-1.4",
            "1 0 obj",
            "<< /Type /Catalog /Pages 2 0 R /AcroForm 5 0 R >>",
            "endobj",
            "2 0 obj",
            "<< /Type /Pages /Count 1 /Kids [3 0 R] /Resources << /Font << /F1 9 0 R >> >> >>",
            "endobj",
            "3 0 obj",
            "<< /Type /Page /Parent 2 0 R /MediaBox [0 0 220 220] /Contents 4 0 R /Annots [8 0 R] >>",
            "endobj",
            "4 0 obj",
            $"<< /Length {existing.Length} >>",
            "stream",
            ...
            "endobj",
            "7 0 obj",
            "<< /FT /Tx /T (Name) /V (Inherited resource value) /Kids [8 0 R] >>",
            "endobj",
            "8 0 obj",
            "<< /Type /Annot /Subtype /Widget /Parent 7 0 R /Rect [20 100 180 120] /F 4 >>",
            "endobj",
    ...
    private static byte[] BuildTaggedTextWidgetWithIndirectParentTreeArraysPdf() {
        string pdf = string.Join("\n", new[] {
            "%PDF-1.4",
            "1 0 obj", "<< /Type /Catalog /Pages 2 0 R /AcroForm 5 0 R /MarkInfo << /Marked true >> /StructTreeRoot 9 0 R >>", "endobj",
            "2 0 obj", "<< /Type /Pages /Count 1 /Kids [3 0 R] >>", "endobj",
            ...
            "10 0 obj", "<< /Type /StructElem /S /Document /P 9 0 R /K [11 0 R] >>", "endobj",
            "11 0 obj", "<< /Type /StructElem /S /Form /P 10 0 R /K 13 0 R >>", "endobj",
            "12 0 obj", "<< /Kids 15 0 R >>", "endobj",
            "13 0 obj", "<< /Type /OBJR /Obj 7 0 R >>", "endobj",
            "14 0 obj", "[0 11 0 R]", "endobj",
            "15 0 obj", "[16 0 R]", "endobj",
            "16 0 obj", "<< /Nums 14 0 R >>", "endobj",
            "trailer", "<< /Root 1 0 R /Size 17 >>", "%%EOF"
        });
        return Encoding.ASCII.GetBytes(pdf);
    }

    private static byte[] BuildTaggedTextWidgetWithIndirectStructureKidArraysPdf() {
        string pdf = string.Join("\n", new[] {
            "%PDF-1.4",
            "1 0 obj", "<< /Type /Catalog /Pages 2 0 R /AcroForm 5 0 R /MarkInfo << /Marked true >> /StructTreeRoot 9 0 R >>", "endobj",
            "2 0 obj", "<< /Type /Pages /Count 1 /Kids [3 0 R] >>", "endobj",
            ...
            "6 0 obj", "<< /FT /Tx /T (Name) /V (Ada) /Kids [7 0 R] >>", "endobj",
            "7 0 obj", "<< /Type /Annot /Subtype /Widget /Parent 6 0 R /Rect [20 100 180 120] /F 4 /StructParent 0 >>", "endobj",
            "9 0 obj", "<< /Type /StructTreeRoot /K 17 0 R /ParentTree 12 0 R /ParentTreeNextKey 1 >>", "endobj",
            "10 0 obj", "<< /Type /StructElem /S /Document /P 9 0 R /K 18 0 R >>", "endobj",
            "11 0 obj", "<< /Type /StructElem /S /Form /P 10 0 R /K 19 0 R >>", "endobj",
            "12 0 obj", "<< /Nums [0 11 0 R] >>", "endobj",
            "13 0 obj", "<< /Type /OBJR /Obj 7 0 R >>", "endobj",
            "17 0 obj", "[10 0 R]", "endobj",
            "18 0 obj", "[11 0 R]", "endobj",
            "19 0 obj", "[13 0 R]", "endobj",
            "trailer", "<< /Root 1 0 R /Size 20 >>", "%%EOF"
        });
        return Encoding.ASCII.GetBytes(pdf);
    }

    private static byte[] BuildTaggedTextWidgetWithNestedParentTreeLimitsPdf() {
        string pdf = string.Join("\n", new[] {
            "%PDF-1.4",
            "1 0 obj", "<< /Type /Catalog /Pages 2 0 R /AcroForm 5 0 R /MarkInfo << /Marked true >> /StructTreeRoot 9 0 R >>", "endobj",
            "2 0 obj", "<< /Type /Pages /Count 1 /Kids [3 0 R] >>", "endobj",
            ...
            "6 0 obj", "<< /FT /Tx /T (Name) /V (Ada) /Kids [7 0 R] >>", "endobj",
            "7 0 obj", "<< /Type /Annot /Subtype /Widget /Parent 6 0 R /Rect [20 100 180 120] /F 4 /StructParent 0 >>", "endobj",
            "9 0 obj", "<< /Type /StructTreeRoot /K [11 0 R 14 0 R] /ParentTree 12 0 R /ParentTreeNextKey 10 >>", "endobj",
            "11 0 obj", "<< /Type /StructElem /S /Form /P 9 0 R /K 13 0 R >>", "endobj",
            "12 0 obj", "<< /Kids [15 0 R 16 0 R] /Limits [0 9] >>", "endobj",
            "13 0 obj", "<< /Type /OBJR /Obj 7 0 R >>", "endobj",
            "14 0 obj", "<< /Type /StructElem /S /P /P 9 0 R /K 0 >>", "endobj",
            "15 0 obj", "<< /Nums [0 11 0 R 5 14 0 R] /Limits [0 5] >>", "endobj",
            "16 0 obj", "<< /Nums [9 11 0 R] /Limits [9 9] >>", "endobj",
            "trailer", "<< /Root 1 0 R /Size 17 >>", "%%EOF"
        });
        return Encoding.ASCII.GetBytes(pdf);
    }

    private static byte[] BuildTaggedTextWidgetWithIdTreePdf() {
        string pdf = string.Join("\n", new[] {
            "%PDF-1.4",
            "1 0 obj", "<< /Type /Catalog /Pages 2 0 R /AcroForm 5 0 R /MarkInfo << /Marked true >> /StructTreeRoot 9 0 R >>", "endobj",
            "2 0 obj", "<< /Type /Pages /Count 1 /Kids [3 0 R] >>", "endobj",
            ...
            "6 0 obj", "<< /FT /Tx /T (Name) /V (Ada) /Kids [7 0 R] >>", "endobj",
            "7 0 obj", "<< /Type /Annot /Subtype /Widget /Parent 6 0 R /Rect [20 100 180 120] /F 4 /StructParent 0 >>", "endobj",
            "9 0 obj", "<< /Type /StructTreeRoot /K [10 0 R] /ParentTree 12 0 R /ParentTreeNextKey 1 /IDTree 20 0 R >>", "endobj",
            "10 0 obj", "<< /Type /StructElem /S /Document /P 9 0 R /ID (document-id) /K [<< /Type /MCR /Pg 3 0 R /MCID 0 >> 11 0 R] >>", "endobj",
            "11 0 obj", "<< /Type /StructElem /S /Form /P 10 0 R /ID (form-id) /K 13 0 R >>", "endobj",
            "12 0 obj", "<< /Nums [0 11 0 R] >>", "endobj",
            "13 0 obj", "<< /Type /OBJR /Obj 7 0 R >>", "endobj",
            "20 0 obj", "<< /Kids 21 0 R >>", "endobj",
            "21 0 obj", "[22 0 R]", "endobj",
            "22 0 obj", "<< /Names 23 0 R /Limits [(document-id) (form-id)] >>", "endobj",
            "23 0 obj", "[(document-id) 10 0 R (form-id) 11 0 R]", "endobj",
            "trailer", "<< /Root 1 0 R /Size 24 >>", "%%EOF"
        });
        return Encoding.ASCII.GetBytes(pdf);
    }
