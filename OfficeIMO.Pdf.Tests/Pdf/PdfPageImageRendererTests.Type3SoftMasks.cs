...
public partial class PdfPageImageRendererTests {
    ...
    public void RenderPage_FailsClosedForSubToleranceInheritedType3SoftMaskState() {
        ...
        string state = "7 0 obj\n<< /Type /ExtGState /LW 0.9999995 /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string mask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << >>", "0 0 m 500 700 l S");
    ...
    public void RenderPage_DoesNotReuseLuminosityMaskValidationAcrossInheritedColors() {
        ...
        string mask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "0 0 500 700 re f");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, state, mask);
    ...
    [Fact]
    public void RenderPage_FailsClosedWhenLuminosityTransparencyProofDependsOnInheritedFill() {
        string type3Font = "5 0 obj\n<< /Type /Font /Subtype /Type3 /FontBBox [0 0 500 700] /FontMatrix [0.001 0 0 0.001 0 0] /CharProcs << /A 6 0 R >> /Encoding << /Differences [65 /A] >> /FirstChar 65 /LastChar 65 /Widths [500] /Resources << /ExtGState << /GS1 7 0 R >> >> >>\nendobj";
        string glyph = BuildStreamObject(6, "<<", "500 0 d0 1 0 0 rg /GS1 gs 0 0 500 700 re f");
        string state = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string mask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "0 0 500 700 re f");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyph, state, mask);
    ...
    public void RenderPage_FailsClosedForOptionalContentOnNestedFormInsideType3SoftMask() {
        ...
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /XObject << /Fm1 9 0 R >> >>", "/Fm1 Do");
    ...
    public void RenderPage_FailsClosedForMalformedOperatorInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << >>", "/Bad 0 0 1 0 0 cm 0 0 500 700 re f");
    ...
    [Fact]
    public void RenderPage_FailsClosedForMalformedType3SoftMaskResources() {
        string type3Font = "5 0 obj\n<< /Type /Font /Subtype /Type3 /FontBBox [0 0 500 700] /FontMatrix [0.001 0 0 0.001 0 0] /CharProcs << /A 6 0 R >> /Encoding << /Differences [65 /A] >> /FirstChar 65 /LastChar 65 /Widths [500] /Resources << /ExtGState << /GS1 7 0 R >> >> >>\nendobj";
        string glyph = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string graphicsState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string mask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources /Bad", "0 0 500 700 re f");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyph, graphicsState, mask);
    ...
    public void RenderPage_FailsClosedForMissingDirectPatternInsideType3SoftMask(string maskContent) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Pattern << >> >>", maskContent);
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_FailsClosedForMissingDirectColorSpaceInsideType3SoftMask(string maskContent) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << >>", maskContent);
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_IgnoresInvisibleTransparencyFormInsideType3SoftMask(string maskContent, string extraResources, string? extraObject) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /XObject << /Bad 9 0 R >> " + extraResources + " >>", maskContent);
        string unsupportedGroup = BuildStreamObject(9, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "0 0 500 700 re f");
    ...
    public void RenderPage_IgnoresRestoredUnsupportedSoftMaskBeforeVisiblePaint() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /ExtGState << /Bad 9 0 R >> >>", "q /Bad gs Q 0 0 500 700 re f");
    ...
    public void RenderPage_ValidatesNestedSoftMaskWhenDirectShadingPaints(string maskContent, bool expectFallback) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /ExtGState << /Bad 9 0 R >> /Shading << /Sh1 10 0 R >> >>", maskContent);
    ...
    public void RenderPage_IgnoresNestedSoftMaskForFullyTransparentDirectShading() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /ExtGState << /Bad 9 0 R /Zero 12 0 R >> /Shading << /Sh1 10 0 R >> >>", "q /Bad gs /Zero gs /Sh1 sh Q 0 0 500 700 re f");
        string unsupportedState = "9 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 11 0 R >> >>\nendobj";
        string shading = "10 0 obj\n<< /ShadingType 2 /ColorSpace /DeviceRGB /Coords [0 0 500 0] /Function << /FunctionType 2 /Domain [0 1] /C0 [1 1 1] /C1 [1 1 1] /N 1 >> /Extend [true true] >>\nendobj";
        string malformedMaskGroup = BuildStreamObject(11, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Resources << >>", "0 0 500 700 re f");
    ...
    public void RenderPage_IgnoresStrokeGroupWhenCompositingOpacityIsZero() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /ExtGState << /GSZero 10 0 R >> /XObject << /Bad 9 0 R >> >>", "/GSZero gs /Bad Do");
        string unsupportedGroup = BuildStreamObject(9, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "10 w 0 0 m 500 700 l S");
    ...
    public void RenderPage_AppliesSoftMaskGroupMatrixDuringValidation() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [1000 0 1500 700] /Matrix [1 0 0 1 -1000 0] /Group << /Type /Group /S /Transparency /I true >> /Resources << /XObject << /Bad 9 0 R >> >>", "/Bad Do");
        string unsupportedGroup = BuildStreamObject(9, "<< /Type /XObject /Subtype /Form /BBox [1000 0 1500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "1000 0 500 700 re f");
    ...
    public void RenderPage_BoundsSoftMaskType3ValidationAcrossTextBatches() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Font << /Nested 9 0 R >> >>", "BT /Nested 500 Tf (BB) Tj ET");
    ...
    public void RenderPage_ReusesSoftMaskValidationBudgetAcrossPatternGlyphs() {
        ...
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Pattern << /P1 9 0 R >> >>", "/Pattern cs /P1 scn 0 0 500 700 re f");
        ...
        string nestedMask = BuildStreamObject(13, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Font << /Deep 14 0 R >> >>", "BT /Deep 500 Tf (C) Tj ET /Missing Do");
    ...
    public void RenderPage_ReusesSoftMaskTextBudgetAcrossPatternGlyphs() {
        ...
        string outerGlyph = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Font << /Nested 9 0 R >> >>", "BT /Nested 500 Tf (BB) Tj ET /Missing Do");
    ...
    public void RenderPage_CarriesSoftMaskDepthIntoStrictPatternsNestedInGlyphs() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Font << /Nested 9 0 R >> >>", "BT /Nested 500 Tf (B) Tj ET");
        string nestedFont = "9 0 obj\n<< /Type /Font /Subtype /Type3 /PaintType 1 /FontBBox [0 0 500 700] /FontMatrix [0.001 0 0 0.001 0 0] /CharProcs << /B 10 0 R >> /Encoding << /Differences [66 /B] >> /FirstChar 66 /LastChar 66 /Widths [500] /Resources << /Pattern << /P1 11 0 R >> >> >>\nendobj";
        string nestedGlyph = BuildStreamObject(10, "<<", "500 0 d0 /Pattern cs /P1 scn 0 0 500 700 re f");
    ...
    public void RenderPage_DoesNotReusePatternMaskDepthAcrossNestedCalls() {
        ...
        string maskGroup = BuildStreamObject(10, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Pattern << /P1 11 0 R >> >>", "/Pattern cs /P1 scn 0 0 500 700 re f");
        string pattern = BuildStreamObject(11, "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 10 10] /XStep 10 /YStep 10 /Resources << /XObject << /F1 12 0 R >> >>", "/F1 Do");
        string nestedForm = BuildStreamObject(12, "<< /Type /XObject /Subtype /Form /BBox [0 0 10 10] /Resources << >>", "0 0 10 10 re f");
        byte[] pdf = BuildSingleStreamPdf(
            "BT /FType3 18 Tf 20 100 Td (A) Tj ET",
    ...
    public void RenderPage_FailsClosedForNestedSoftMaskPayloadInsideStrictPatternCell() {
        ...
        string nestedMask = BuildStreamObject(11, "<< /Type /XObject /Subtype /Form /BBox [0 0 10 10] /Group << /Type /Group /S /Transparency /I true >> /Resources << /XObject << >> >>", "/Missing Do");
    ...
    public void RenderPage_FailsClosedForUnsupportedOrdinaryTextInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "BT /Missing 48 Tf 0 100 Td (A) Tj ET");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_FailsClosedWhenLuminositySoftMaskDependsOnInheritedColor() {
        ...
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "0 0 500 700 re f");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_FailsClosedForMissingClippingTextFontInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << >>", "BT /Missing 48 Tf 7 Tr 0 100 Td (A) Tj ET 0 0 500 700 re f");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_ProjectsSupportedOrdinaryTextInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << /Font << /FText 9 0 R >> >>", "BT /FText 300 Tf 25 200 Td (A) Tj ET");
    ...
    public void RenderPage_FailsClosedForUnsupportedOrdinaryTextPaintModeInsideType3SoftMask(int renderingMode) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << /Font << /FText 9 0 R >> >>", $"BT /FText 300 Tf {renderingMode} Tr 25 200 Td (A) Tj ET");
        string ordinaryFont = "9 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica /Encoding /WinAnsiEncoding >>\nendobj";
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask, ordinaryFont);
    ...
    public void RenderPage_IgnoresNonpaintingUnsupportedTextInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << /Font << /FText 9 0 R >> >>", "1 1 1 rg 0 0 500 700 re f BT /FText 48 Tf 3 Tr 25 200 Td (A) Tj ET");
    ...
    public void RenderPage_IgnoresTransparentUnsupportedTextInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << /Font << /FText 9 0 R >> /ExtGState << /Zero 10 0 R >> >>", "1 1 1 rg 0 0 500 700 re f /Zero gs BT /FText 48 Tf 25 200 Td (A) Tj ET");
    ...
    public void RenderPage_IgnoresActiveEffectForNonpaintingType3TextInsideSoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /ExtGState << /Bad 9 0 R >> /Font << /Nested 11 0 R >> >>", "q /Bad gs BT /Nested 500 Tf (B) Tj ET Q 0 0 500 700 re f");
        string unsupportedState = "9 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 10 0 R >> >>\nendobj";
        string malformedMaskGroup = BuildStreamObject(10, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Resources << >>", "0 0 500 700 re f");
    ...
    public void RenderPage_FailsClosedForPatternPaintedImageMaskInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Pattern << /P1 9 0 R >> /XObject << /Im1 10 0 R >> >>", "/Pattern cs /P1 scn q 500 0 0 700 0 0 cm /Im1 Do Q");
    ...
    public void RenderPage_InheritsInvokingFormResourcesForNestedSoftMaskGroup() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /XObject << /Nested 9 0 R >> >>", "/Nested Do");
        ...
        string nestedState = "10 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 11 0 R >> >>\nendobj";
        string nestedMask = BuildStreamObject(11, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >>", "q 500 0 0 700 0 0 cm /Im1 Do Q");
    ...
    public void RenderPage_FailsClosedForUnresolvedImageTransparencyInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /XObject << /Im1 9 0 R >> >>", "q 500 0 0 700 0 0 cm /Im1 Do Q");
    ...
    public void RenderPage_FailsClosedForInvalidDirectPatternSelectionInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true >> /Resources << /Pattern << /P1 9 0 R >> >>", "/Pattern cs 1 /P1 scn 0 0 500 700 re f");
    ...
    public void RenderPage_FailsClosedForPatternPaintedOrdinaryTextInsideType3SoftMask(string textRenderingMode) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /Type /Group /S /Transparency /I true /CS /DeviceRGB >> /Resources << /Font << /FText 9 0 R >> /Pattern << /P1 10 0 R >> >>", $"/Pattern cs /P1 scn /Pattern CS /P1 SCN BT /FText 300 Tf {textRenderingMode} Tr 25 200 Td (A) Tj ET");
        string ordinaryFont = "9 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica /Encoding /WinAnsiEncoding >>\nendobj";
