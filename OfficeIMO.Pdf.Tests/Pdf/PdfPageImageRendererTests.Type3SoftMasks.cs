...
public partial class PdfPageImageRendererTests {
    ...
    public void RenderPage_IgnoresRestoredUnsupportedSoftMaskBeforeVisiblePaint() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /ExtGState << /Bad 9 0 R >> >>", "q /Bad gs Q 0 0 500 700 re f");
    ...
    public void RenderPage_ValidatesNestedSoftMaskWhenDirectShadingPaints(string maskContent, bool expectFallback) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /ExtGState << /Bad 9 0 R >> /Shading << /Sh1 10 0 R >> >>", maskContent);
    ...
    public void RenderPage_IgnoresNestedSoftMaskForFullyTransparentDirectShading() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /ExtGState << /Bad 9 0 R /Zero 12 0 R >> /Shading << /Sh1 10 0 R >> >>", "q /Bad gs /Zero gs /Sh1 sh Q 0 0 500 700 re f");
        string unsupportedState = "9 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 11 0 R >> >>\nendobj";
        string shading = "10 0 obj\n<< /ShadingType 2 /ColorSpace /DeviceRGB /Coords [0 0 500 0] /Function << /FunctionType 2 /Domain [0 1] /C0 [1 1 1] /C1 [1 1 1] /N 1 >> /Extend [true true] >>\nendobj";
        string malformedMaskGroup = BuildStreamObject(11, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Resources << >>", "0 0 500 700 re f");
    ...
    public void RenderPage_IgnoresStrokeGroupWhenCompositingOpacityIsZero() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /ExtGState << /GSZero 10 0 R >> /XObject << /Bad 9 0 R >> >>", "/GSZero gs /Bad Do");
    ...
    public void RenderPage_AppliesSoftMaskGroupMatrixDuringValidation() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [1000 0 1500 700] /Matrix [1 0 0 1 -1000 0] /Group << /S /Transparency >> /Resources << /XObject << /Bad 9 0 R >> >>", "/Bad Do");
    ...
    public void RenderPage_BoundsSoftMaskType3ValidationAcrossTextBatches() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /Font << /Nested 9 0 R >> >>", "BT /Nested 500 Tf (BB) Tj ET");
    ...
    public void RenderPage_ReusesSoftMaskTextBudgetAcrossPatternGlyphs() {
        ...
        string outerGlyph = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /Font << /Nested 9 0 R >> >>", "BT /Nested 500 Tf (BB) Tj ET /Missing Do");
    ...
    public void RenderPage_DoesNotReusePatternMaskDepthAcrossNestedCalls() {
        ...
        string maskGroup = BuildStreamObject(10, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /Pattern << /P1 11 0 R >> >>", "/Pattern cs /P1 scn 0 0 500 700 re f");
        string pattern = BuildStreamObject(11, "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 10 10] /XStep 10 /YStep 10 /Resources << /XObject << /F1 12 0 R >> >>", "/F1 Do");
        string nestedForm = BuildStreamObject(12, "<< /Type /XObject /Subtype /Form /BBox [0 0 10 10] /Resources << >>", "0 0 10 10 re f");
        byte[] pdf = BuildSingleStreamPdf(
            "BT /FType3 18 Tf 20 100 Td (A) Tj ET",
    ...
    public void RenderPage_FailsClosedForNestedSoftMaskPayloadInsideStrictPatternCell() {
        ...
        string nestedMask = BuildStreamObject(11, "<< /Type /XObject /Subtype /Form /BBox [0 0 10 10] /Group << /S /Transparency >> /Resources << /XObject << >> >>", "/Missing Do");
    ...
    public void RenderPage_FailsClosedForUnsupportedOrdinaryTextInsideType3SoftMask() {
        ...
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency /CS /DeviceRGB >> /Resources << >>", "BT /Missing 48 Tf 0 100 Td (A) Tj ET");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_FailsClosedForMissingClippingTextFontInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency /CS /DeviceRGB >> /Resources << >>", "BT /Missing 48 Tf 7 Tr 0 100 Td (A) Tj ET 0 0 500 700 re f");
        byte[] pdf = BuildSingleStreamPdf("BT /FType3 18 Tf 20 100 Td (A) Tj ET", "<< /Font << /FType3 5 0 R >> >>", type3Font, glyphA, outerState, outerMask);
    ...
    public void RenderPage_IgnoresActiveEffectForNonpaintingType3TextInsideSoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /ExtGState << /Bad 9 0 R >> /Font << /Nested 11 0 R >> >>", "q /Bad gs BT /Nested 500 Tf (B) Tj ET Q 0 0 500 700 re f");
        string unsupportedState = "9 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 10 0 R >> >>\nendobj";
        string malformedMaskGroup = BuildStreamObject(10, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Resources << >>", "0 0 500 700 re f");
    ...
    public void RenderPage_FailsClosedForPatternPaintedImageMaskInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /Pattern << /P1 9 0 R >> /XObject << /Im1 10 0 R >> >>", "/Pattern cs /P1 scn q 500 0 0 700 0 0 cm /Im1 Do Q");
    ...
    public void RenderPage_InheritsInvokingFormResourcesForNestedSoftMaskGroup() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /XObject << /Nested 9 0 R >> >>", "/Nested Do");
        ...
        string nestedState = "10 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 11 0 R >> >>\nendobj";
        string nestedMask = BuildStreamObject(11, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >>", "q 500 0 0 700 0 0 cm /Im1 Do Q");
    ...
    public void RenderPage_FailsClosedForUnresolvedImageTransparencyInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /XObject << /Im1 9 0 R >> >>", "q 500 0 0 700 0 0 cm /Im1 Do Q");
    ...
    public void RenderPage_FailsClosedForInvalidDirectPatternSelectionInsideType3SoftMask() {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Alpha /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency >> /Resources << /Pattern << /P1 9 0 R >> >>", "/Pattern cs 1 /P1 scn 0 0 500 700 re f");
    ...
    public void RenderPage_FailsClosedForPatternPaintedOrdinaryTextInsideType3SoftMask(string textRenderingMode) {
        ...
        string glyphA = BuildStreamObject(6, "<<", "500 0 d0 /GS1 gs 0 0 500 700 re f");
        string outerState = "7 0 obj\n<< /Type /ExtGState /SMask << /S /Luminosity /G 8 0 R >> >>\nendobj";
        string outerMask = BuildStreamObject(8, "<< /Type /XObject /Subtype /Form /BBox [0 0 500 700] /Group << /S /Transparency /CS /DeviceRGB >> /Resources << /Font << /FText 9 0 R >> /Pattern << /P1 10 0 R >> >>", $"/Pattern cs /P1 scn /Pattern CS /P1 SCN BT /FText 300 Tf {textRenderingMode} Tr 25 200 Td (A) Tj ET");
        string ordinaryFont = "9 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica /Encoding /WinAnsiEncoding >>\nendobj";
