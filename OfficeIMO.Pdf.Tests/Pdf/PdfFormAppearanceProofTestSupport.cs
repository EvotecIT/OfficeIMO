...
internal static class PdfFormAppearanceProofTestSupport {
    ...
    public static byte[] BuildFormAppearanceProofPdf() {
        string pdf = string.Join("\n", new[] {
            ...
            "endobj",
            "14 0 obj",
            "<< /Type /Annot /Subtype /Widget /Parent 13 0 R /Rect [20 32 36 48] /F 4 /AP << /N << /Card 16 0 R >> >> >>",
            "endobj",
            "15 0 obj",
            "<< /Type /Annot /Subtype /Widget /Parent 13 0 R /Rect [80 32 96 48] /F 4 /AP << /N << /Wire 17 0 R >> >> >>",
            "endobj",
