...
public class PdfType3OptionalContentTests {
    ...
    public void RenderPage_FailsClosedForMalformedViewUsageApplicationContainer(string applicationEntry) {
        byte[] pdf = BuildType3OptionalContentPdf(
            nestedForm: false,
            defaultConfigurationEntries: applicationEntry + " /ON [11 0 R] /OFF [10 0 R]");
    ...
    [Fact]
    public void RenderPage_TreatsExplicitNullViewUsageApplicationContainerAsAbsent() {
        byte[] pdf = BuildType3OptionalContentPdf(
            nestedForm: false,
            defaultConfigurationEntries: "/AS null /ON [11 0 R] /OFF [10 0 R]");
    ...
    public void RenderPage_FailsClosedForInlineMembershipWithoutOptionalContentConfiguration() {
        byte[] pdf = BuildType3OptionalContentPdf(
            nestedForm: false,
            inlineMembershipDictionary: "<< /Type /OCMD /OCGs [10 0 R] /P /AnyOn >>",
            omitOptionalContentConfiguration: true);
