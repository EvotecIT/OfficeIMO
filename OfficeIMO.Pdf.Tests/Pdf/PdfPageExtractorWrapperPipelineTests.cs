...
public partial class PdfPageExtractorTests {
    ...
    public void SplitExtractAndMerge_PreserveStatementFixtureReadbackForWrapperPipelines() {
        ...
        PdfDocumentReadResult firstSplit = PdfDocumentReadResult.Load(splitPages[0]);
        PdfDocumentReadResult secondSplit = PdfDocumentReadResult.Load(splitPages[1]);
        ...
        PdfDocumentReadResult extractedLogical = PdfDocumentReadResult.Load(extractedReversed);
        ...
        PdfDocumentReadResult mergedLogical = PdfDocumentReadResult.Load(mergedReversed);
