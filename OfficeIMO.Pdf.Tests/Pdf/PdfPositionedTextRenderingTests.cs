...
public sealed class PdfPositionedTextRenderingTests {
    ...
    public void PageRotationRetainsEverySourceGlyph(int rotation) {
        ...
        OfficeRasterImage source = OfficeDrawingRasterRenderer.Render(document.Render.Drawing(1));
        OfficeRasterImage rotated = OfficeDrawingRasterRenderer.Render(document.Pages.Rotate(rotation).Render.Drawing(1));
        ...
        Assert.InRange(rotatedInk, (long)(sourceInk * 0.95), (long)(sourceInk * 1.05));
    }
}
