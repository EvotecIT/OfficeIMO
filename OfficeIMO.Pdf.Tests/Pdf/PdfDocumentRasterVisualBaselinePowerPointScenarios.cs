...
public partial class PdfDocumentRasterVisualBaselineTests {
    ...
    private static byte[] CreateNativePowerPointSlide() {
        ...
        slide.AddPicture(new MemoryStream(CreatePowerPointVisualGatePng()), PowerPointImagePartType.Png, PowerPointUnits.FromPoints(250), PowerPointUnits.FromPoints(22), PowerPointUnits.FromPoints(42), PowerPointUnits.FromPoints(30));
    ...
    private static byte[] CreateNativePowerPointDenseLayout() {
        ...
        PowerPointPicture picture = slide.AddPicture(new MemoryStream(logoBytes), PowerPointImagePartType.Png, PowerPointUnits.FromPoints(220), PowerPointUnits.FromPoints(18), PowerPointUnits.FromPoints(64), PowerPointUnits.FromPoints(30));
