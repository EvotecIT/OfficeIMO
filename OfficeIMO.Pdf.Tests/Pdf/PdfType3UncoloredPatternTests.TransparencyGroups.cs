...
public partial class PdfType3UncoloredPatternTests {
    ...
    [Fact]
    public void RenderPage_FailsClosedForNonConformalTransparencyGroupStrokeTransform() {
        byte[] pdf = BuildUncoloredType3PatternPdf(
    ...
    public void RenderPage_FailsClosedForInvalidNumericOperandsInStrictType3Content(string glyphContent) {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            ...
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
            patternContent: "1 0 0 rg 0 0 5 5 re f",
            glyphContent: "500 0 d0 " + glyphContent);
    ...
    [Fact]
    public void RenderPage_FailsClosedForSurplusStrictGraphicsStateOperands() {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            pageContent: "/Pattern cs /P1 scn BT /FType3 18 Tf 20 100 Td (A) Tj ET",
            pageColorSpaceResources: string.Empty,
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
            patternContent: "1 0 0 rg 0 0 5 5 re f",
            glyphContent: "500 0 d0 /Extra /Half gs 0 0 500 700 re f",
            glyphResources: "<< /ExtGState << /Half << /ca 0.5 >> >> >>");
    ...
    [Fact]
    public void RenderPage_FailsClosedForNonFiniteDirectType3StrokeWidth() {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            pageContent: "/Pattern CS /P1 SCN BT /FType3 18 Tf 20 100 Td (A) Tj ET",
            pageColorSpaceResources: string.Empty,
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
            patternContent: "1 0 0 rg 0 0 5 5 re f",
            glyphContent: "500 0 d0 10 w 1e999 w 0 0 m 500 700 l S");
    ...
    public void RenderPage_FailsClosedForMalformedType3TextStateOperands(string textStateOperator) {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            pageContent: "/Pattern CS /P1 SCN BT /FType3 18 Tf 20 100 Td (A) Tj ET",
            pageColorSpaceResources: string.Empty,
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
            patternContent: "1 0 0 rg 0 0 5 5 re f",
            glyphContent: "500 0 d0 BT /Inner 500 Tf " + textStateOperator + " (A) Tj ET",
            glyphResources: "<< /Font << /Inner 8 0 R >> >>",
            extraObjects: new[] {
                "8 0 obj\n<< /Type /Font /Subtype /Type3 /PaintType 2 /FontBBox [0 0 500 700] /FontMatrix [0.001 0 0 0.001 0 0] /CharProcs << /A 9 0 R >> /Encoding << /Differences [65 /A] >> /FirstChar 65 /LastChar 65 /Widths [500] /Resources << >> >>\nendobj",
    ...
    [Theory]
    [InlineData("99 (A) Tj")]
    [InlineData("[(A) true] TJ")]
    [InlineData("99 (A) '")]
    [InlineData("1 2 3 (A) \"")]
    public void RenderPage_FailsClosedForMalformedType3TextShowOperands(string textShowOperator) {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            pageContent: "/Pattern CS /P1 SCN BT /FType3 18 Tf 20 100 Td (A) Tj ET",
            pageColorSpaceResources: string.Empty,
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
            patternContent: "1 0 0 rg 0 0 5 5 re f",
            glyphContent: "500 0 d0 BT /Inner 500 Tf " + textShowOperator + " ET",
            glyphResources: "<< /Font << /Inner 8 0 R >> >>",
            extraObjects: new[] {
                "8 0 obj\n<< /Type /Font /Subtype /Type3 /PaintType 2 /FontBBox [0 0 500 700] /FontMatrix [0.001 0 0 0.001 0 0] /CharProcs << /A 9 0 R >> /Encoding << /Differences [65 /A] >> /FirstChar 65 /LastChar 65 /Widths [500] /Resources << >> >>\nendobj",
                StreamObject(9, "<<", "500 0 d0 0 0 500 700 re f")
    ...
    [Fact]
    public void RenderPage_FailsClosedForMalformedInlineImageInBlackLuminosityProof() {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            pageContent: "/Pattern cs /P1 scn BT /FType3 18 Tf 20 100 Td (A) Tj ET",
            pageColorSpaceResources: string.Empty,
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
    ...
    [Fact]
    public void RenderPage_RetainsFreeformClipForSlightlyRotatedTransparencyGroup() {
        byte[] pdf = BuildUncoloredType3PatternPdf(
            pageContent: "/Pattern cs /P1 scn BT /FType3 18 Tf 20 100 Td (A) Tj ET",
            pageColorSpaceResources: string.Empty,
            patternDictionary: "<< /Type /Pattern /PatternType 1 /PaintType 1 /TilingType 1 /BBox [0 0 5 5] /XStep 5 /YStep 5 /Resources << >>",
        ...
        Assert.Contains(group.Drawing.Elements.OfType<OfficeDrawingGroup>(), clipped => clipped.ClipPath.Kind == OfficeClipPathKind.Path);
    }
