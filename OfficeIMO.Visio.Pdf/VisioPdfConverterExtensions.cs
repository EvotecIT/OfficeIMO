...
public static class VisioPdfConverterExtensions {
    ...
    public static PdfCore.PdfDocument ToPdfDocument(this VisioDocument document, VisioToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfDocumentConversionResult ToPdfDocumentResult(this VisioDocument document, VisioToPdfOptions? options = null) =>
        VisioPdfConversionEngine.Convert(document, options);

    /// <summary>Converts a Visio document to PDF bytes.</summary>
    public static byte[] ToPdfBytes(this VisioDocument document, VisioToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdf(this VisioDocument document, string path, VisioToPdfOptions? options = null) =>
        document.ToPdfDocumentResult(options).Save(path);

    /// <summary>Writes a Visio document as PDF to a caller-owned stream.</summary>
    public static PdfCore.PdfSaveResult SaveAsPdf(this VisioDocument document, Stream stream, VisioToPdfOptions? options = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this VisioDocument document, string path, VisioToPdfOptions? options = null) {
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this VisioDocument document, Stream stream, VisioToPdfOptions? options = null) {
