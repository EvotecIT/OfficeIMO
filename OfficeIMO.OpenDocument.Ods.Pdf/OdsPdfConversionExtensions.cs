...
public static class OdsPdfConversionExtensions {
    ...
    public static PdfCore.PdfDocument ToPdfDocument(this OdsDocument source, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) =>
    ...
    public static PdfCore.PdfDocumentConversionResult ToPdfDocumentResult(this OdsDocument source, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) {
    ...
    public static byte[] ToPdfBytes(this OdsDocument source, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) =>
        source.ToPdfDocumentResult(conversionOptions, pdfOptions).ToBytes();

    /// <summary>Saves an ODS workbook as PDF.</summary>
    public static PdfCore.PdfSaveResult SaveAsPdf(this OdsDocument source, string path, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdf(this OdsDocument source, Stream stream, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) =>
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this OdsDocument source, string path, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) {
    ...
    public static PdfCore.PdfSaveResult SaveAsPdfResult(this OdsDocument source, Stream stream, ExcelOpenDocumentConversionOptions? conversionOptions = null, ExcelPdf.ExcelToPdfOptions? pdfOptions = null) {
