...
/// </summary>
public class WordImageShapeStyle {
    ...
    /// <summary>
    /// Parses a semicolon delimited style string into an <see cref="WordImageShapeStyle"/> instance.
    /// </summary>
    /// <param name="styleString">The style string.</param>
    /// <returns>A populated <see cref="WordImageShapeStyle"/>.</returns>
    public static WordImageShapeStyle FromString(string styleString) {
        ...
        var shapeStyle = new WordImageShapeStyle();
