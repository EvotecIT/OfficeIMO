namespace OfficeIMO.Word.LegacyDoc.Model {
    internal sealed class LegacyDocEndnote {
        internal LegacyDocEndnote(int referenceCharacterPosition, IReadOnlyList<string> paragraphs) {
        ...
        internal LegacyDocEndnote(int referenceCharacterPosition, IReadOnlyList<LegacyDocNoteParagraph> paragraphs) {
            ReferenceCharacterPosition = referenceCharacterPosition;
            ParagraphRuns = paragraphs.Count == 0
                ? Array.Empty<LegacyDocNoteParagraph>()
                : paragraphs.ToArray();
