...
| Tables | Supported | Table creation, built-in styles, merge/split, nested tables, widths, row heights, borders, shading, repeat headers, page-break behavior, and object-table helpers are supported. Complex externally authored table mutation still needs broader corpus coverage. |
