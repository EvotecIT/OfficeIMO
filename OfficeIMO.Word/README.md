...
document.AddParagraph("Quarterly report").SetStyle("Heading1");
document.AddParagraph("Created with OfficeIMO.Word.");

var table = document.AddTable(2, 2);
table[1, 1].Text = "Area";
table[1, 2].Text = "Status";
table[2, 1].Text = "Documents";
table[2, 2].Text = "Generated";
...
table[1, 1].Text = "Area";
table[1, 2].Text = "Owner";
table[1, 3].Text = "Status";
table.HeaderRow = true;
table.Style = WordTableStyle.TableGrid;

table[2, 1].Text = "Documents";
table[2, 2].Text = "Operations";
table[2, 3].Text = "Ready";

table.MergeCells(3, 1, 3, 3);
table[3, 1].Text = "Generated by OfficeIMO.Word";
```
...
section.Headers.Default.AddParagraph("Internal report");
section.Footers.Default.AddParagraph().AddText("Page ");
section.Footers.Default.AddPageNumber();
```
...
```csharp
document.AddParagraph("Chapter 1").SetStyle("Heading1");
document.AddParagraph("Section 1.1").SetStyle("Heading2");
...
merge.AddField(WordFieldType.MergeField, customFormat: "CustomerName");
...
```csharp
document.ProtectDocument(enforce: true, password: "owner-password");
```
...
string html = WordHtmlConverter.ToHtml(document);
string markdown = WordMarkdownConverter.ToMarkdown(document);
