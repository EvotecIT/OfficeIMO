...
namespace OfficeIMO.Word.Fluent {
    ...
    public class WordTableBuilder {
        ...
        internal WordTableBuilder(WordFluentDocument fluent) {
            _fluent = fluent;
        }

        internal WordTableBuilder(WordFluentDocument fluent, WordTable table) {
            _fluent = fluent;
            _table = table;
        ...
        /// <returns>The current <see cref="WordTableBuilder"/>.</returns>
        public WordTableBuilder Create(int rows, int columns) {
            _columns = columns;
        ...
        /// </summary>
        public WordTableBuilder Columns(int columns) {
            _columns = columns;
            return this;
        }
        ...
        /// </summary>
        public WordTableBuilder PreferredWidth(int? percent = null, int? points = null) {
            if (_table != null) {
                if (percent.HasValue) {
                    _table.WidthType = WordTableWidthUnit.Pct;
        ...
        /// </summary>
        public WordTableBuilder Header(params object[] cells) {
            if (_columns == 0) {
        ...
        /// </summary>
        public WordTableBuilder Headers(params string[] headers) {
        ...
        /// </summary>
        public WordTableBuilder Row(params object[] cells) {
            if (_columns == 0) {
                _columns = cells.Length;
            }
            EnsureTable(1);
        ...
        /// </summary>
        public WordTableBuilder Rows(System.Collections.Generic.IEnumerable<System.Collections.Generic.IReadOnlyList<string>> rows) {
        ...
        /// </summary>
        public WordTableBuilder Rows(System.Collections.Generic.IEnumerable<(string, string)> rows) {
        ...
        /// </summary>
        public WordTableBuilder Rows(System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<string, string>> rows) {
        ...
        /// </summary>
        public WordTableBuilder Style(WordTableStyle style) {
            if (_table != null) {
                _table.Style = style;
            }
            return this;
        ...
        /// </summary>
        public WordTableBuilder Align(WordTableAlignment alignment) {
            if (_table != null) {
                _table.Alignment = alignment;
            }
            return this;
        }
        ...
        /// </summary>
        public WordTableBuilder From2D(object[,] data) {
        ...
        /// </summary>
        public WordTableBuilder HeaderRow(int index) {
        ...
        /// </summary>
        public WordTableBuilder Cell(int row, int column, Action<WordTableCell> action) {
        ...
        /// </summary>
        public WordTableBuilder ForEachCell(Func<int, int, string> textFactory) {
            if (_table != null) {
        ...
        /// </summary>
        public WordTableBuilder ForEachCell(Action<int, int, WordTableCell> action) {
            if (_table != null) {
                for (int r = 0; r < _table.Rows.Count; r++) {
                    var row = _table.Rows[r];
                    for (int c = 0; c < row.CellsCount; c++) {
        ...
        /// </summary>
        public WordTableBuilder InsertRow(int index, params object[] cells) {
            EnsureTable();
            if (_table == null) {
                return this;
            }
        ...
        /// </summary>
        public WordTableBuilder InsertColumn(int index, params object[] cells) {
            EnsureTable();
            if (_table == null) {
                return this;
            }
        ...
        /// </summary>
        public WordTableBuilder DeleteRow(int index) {
        ...
        /// </summary>
        public WordTableBuilder DeleteColumn(int index) {
        ...
        /// </summary>
        public WordTableBuilder Merge(int fromRow, int fromColumn, int toRow, int toColumn) {
            if (_table != null) {
        ...
        /// </summary>
        public WordTableBuilder ColumnWidth(int columnIndex, double widthPoints) {
        ...
        /// </summary>
        public WordTableBuilder ColumnWidthsPercentage(params int[] percentages) {
        ...
        /// </summary>
        public WordTableBuilder RowHeight(int rowIndex, double heightPoints) {
        ...
        /// </summary>
        public WordTableBuilder CellStyle(int row, int column, Action<WordTableCell> action) {
        ...
        /// </summary>
        public WordTableBuilder RowStyle(int index, Action<WordTableRow> action) {
            if (_table != null && index >= 1 && index <= _table.Rows.Count) {
        ...
        /// </summary>
        public WordTableBuilder ColumnStyle(int index, Action<WordTableCell> action) {
            if (_table != null && index >= 1) {
                foreach (var row in _table.Rows) {
                    if (index <= row.CellsCount) {
