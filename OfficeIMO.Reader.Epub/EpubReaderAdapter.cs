...
/// <summary>
/// EPUB ingestion adapter for <see cref="OfficeDocumentReader"/>.
/// </summary>
internal static partial class EpubReaderAdapter {
    /// <summary>
    /// Reads EPUB content from a file path and emits normalized chunks.
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(string epubPath, ReaderOptions? readerOptions = null, EpubReadOptions? epubOptions = null, CancellationToken cancellationToken = default) {
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(Stream epubStream, string? sourceName = null, ReaderOptions? readerOptions = null, EpubReadOptions? epubOptions = null, CancellationToken cancellationToken = default) {
    ...
    private static IEnumerable<ReaderChunk> ReadDocument(EpubDocument document, SourceMetadata source, ReaderOptions options, CancellationToken cancellationToken) {
