...
internal sealed class OcrStartedProcess : IDisposable {
    private bool _disposed;

    internal OcrStartedProcess(System.Diagnostics.Process process, TextReader standardOutput, TextReader standardError) {
        Process = process;
