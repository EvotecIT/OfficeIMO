...
public sealed class OcrProcessCommand {
...
public static class OcrProcessRunner {
    ...
    public static async Task<OcrProcessResult> RunAsync(OcrProcessCommand command, CancellationToken cancellationToken = default) {
        ...
        using OcrProcessLifetime processLifetime = OcrProcessLifetime.Configure(startInfo, command.FileName, arguments);
        using OcrStartedProcess startedProcess = processLifetime.Start(startInfo);
