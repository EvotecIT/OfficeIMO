...
public sealed partial class OfficeTrueTypeFont : IOfficeBoundedFontProgram, IOfficeFontBaselineMetrics, IOfficeVariableFontProgram, IOfficeColorFontProgram {
    ...
    /// <summary>Attempts to load a common platform font without using operating-system font APIs.</summary>
    /// <returns>The first suitable font found, or <see langword="null"/> when none can be loaded.</returns>
