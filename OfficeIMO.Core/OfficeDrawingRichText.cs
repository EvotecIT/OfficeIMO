...
public sealed class OfficeDrawingRichText : OfficeDrawingElement {
    ...
    public OfficeDrawingRichText(
        ...
        for (int i = 0; i < runs.Count; i++) {
            ...
            copiedRuns.Add(new OfficeRichTextRun(run.Text, run.FontSize, run.Color, run.Bold, run.Italic, run.Underline, run.FontFamily, run.Strikethrough, run.BackgroundColor, run.UnderlineStyle, run.StrikethroughStyle, run.Baseline) { LinkUri = run.LinkUri });
