...
internal static class OfficeProvenancePackageMutation {
    internal static OfficeProvenanceRemovalResult RemoveFile(
        ...
        OfficeProvenanceRemovalResult result = Remove(data, fullInputPath, options, stripSignatures);
    ...
    internal static OfficeProvenanceRemovalResult Remove(
        ...
        options ??= new OfficeProvenanceRemovalOptions();
        if (options.SignatureMutationPolicy != OfficeSignatureMutationPolicy.RemoveInvalidatedSignatures) {
        ...
        bool hadSignatureEvidence = OfficeProvenanceZip.HasPackageSignature(data, options);
        ...
        if (OfficeProvenanceZip.HasPackageSignature(stripped.Data, options)) {
