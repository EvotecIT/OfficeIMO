...
public static partial class RtfHtmlConverterExtensions {
    ...
    public static Task<RtfDocument> LoadFromHtmlAsync(this string html, RtfHtmlReadOptions? options = null, CancellationToken cancellationToken = default) {
        if (html == null) {
    ...
    public static Task<RtfDocument> LoadFromHtmlAsync(this byte[] htmlBytes, RtfHtmlReadOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (htmlBytes == null) {
    ...
    public static async Task<RtfDocument> LoadFromHtmlAsync(this Stream htmlStream, RtfHtmlReadOptions? options = null, Encoding? encoding = null, CancellationToken cancellationToken = default) {
        if (htmlStream == null) {
