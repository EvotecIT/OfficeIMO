...
/// <summary>
/// HTML ingestion adapter for <see cref="OfficeDocumentReader"/>.
/// </summary>
internal static partial class HtmlReaderAdapter {
    /// <summary>
    /// Reads an HTML file and emits normalized chunks.
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(string htmlPath, ReaderOptions? readerOptions = null, ReaderHtmlOptions? htmlOptions = null, CancellationToken cancellationToken = default) {
        ...
        foreach (var chunk in Read(fs, source, effectiveReaderOptions, htmlOptions, cancellationToken)) {
            yield return chunk;
        }
    }
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> Read(Stream htmlStream, string? sourceName = null, ReaderOptions? readerOptions = null, ReaderHtmlOptions? htmlOptions = null, CancellationToken cancellationToken = default) {
        ...
        foreach (var chunk in Read(htmlStream, source, effectiveReaderOptions, htmlOptions, cancellationToken)) {
            yield return chunk;
        }
    }

    private static IEnumerable<ReaderChunk> Read(Stream htmlStream, SourceMetadata source, ReaderOptions effectiveReaderOptions, ReaderHtmlOptions? htmlOptions, CancellationToken cancellationToken) {
    ...
    /// </summary>
    public static IEnumerable<ReaderChunk> ReadContent(string html, string sourceName = "document.html", ReaderOptions? readerOptions = null, ReaderHtmlOptions? htmlOptions = null, CancellationToken cancellationToken = default) {
        ...
        foreach (var chunk in ReadContent(html, source, effective, htmlOptions, cancellationToken)) {
            yield return chunk;
        }
    }
