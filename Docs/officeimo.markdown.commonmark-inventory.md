...
| Pinned smoke fixtures | 294 |
| Passing pinned fixtures | 294 |
| Passing unpinned examples | 325 |
| Failing examples | 33 |
...
| Code span normalization and precedence | 2 | Code spans | #333, #334 |
