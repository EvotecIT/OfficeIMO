...
dotnet test OfficeIMO.Markdown.Tests\OfficeIMO.Markdown.Tests.csproj --framework net8.0 --filter "FullyQualifiedName~Markdown_CommonMark_Inventory_Tests"
...
| Pinned smoke fixtures | 317 |
| Passing pinned fixtures | 317 |
