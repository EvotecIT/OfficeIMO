...
dotnet test .\OfficeIMO.Visio.Tests\OfficeIMO.Visio.Tests.csproj -c Release --framework net8.0 --no-build --filter "FullyQualifiedName~Visio" --logger "console;verbosity=minimal"
```
