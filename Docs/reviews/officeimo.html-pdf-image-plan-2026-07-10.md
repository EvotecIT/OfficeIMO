...
- [ ] Complete table layout and row/cell fragmentation. Styled top/bottom captions, empty-table caption retention, occupancy-grid column placement, column spans, row-group-bounded row spans, span height, and span-safe row breaks are implemented; intrinsic column sizing, separate/collapsed border models, and cell-content fragmentation remain.
