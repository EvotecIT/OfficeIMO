...
- [x] A single oversized vertical flex item now projects its nested safe block/line boundaries into the container flow, allowing page fragmentation without forced visual slicing; multi-line and overlapping flex/grid fragmentation remain advanced work.
