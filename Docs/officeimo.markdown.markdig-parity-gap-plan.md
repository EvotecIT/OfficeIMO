...
| CommonMark corpus | 267 of 652 official CommonMark `0.31.2` examples pinned as smoke fixtures |
| CommonMark full inventory | 587 of 652 official CommonMark `0.31.2` examples currently match; 65 are failing in `Docs/officeimo.markdown.commonmark-inventory.md` |
