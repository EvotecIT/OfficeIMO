...
- [ ] **P1 - Finish `UseNonAsciiNoEscape`.** Type: renderer policy. Visible text paths are mostly routed through `HtmlOptions.EscapeNonAsciiText`; remaining work is attributes, sanitizer/security-owned escaping, and custom renderer-extension output.
