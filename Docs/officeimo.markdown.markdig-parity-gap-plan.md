...
- [ ] **Promote or explicitly bound `UseDefinitionLists`.**
  ...
  - [ ] Broaden nested-body cases for blockquote source breadth, remaining fenced-code variants beyond closed marker-line/empty-marker boundary cases, remaining setext-looking interruption cases after nested body boundaries, and remaining list-tail variants after nested body boundaries.
