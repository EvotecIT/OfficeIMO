...
- [ ] **4. Engine plus proof: close `UseDefinitionLists`.** Existing behavior is real but still `Partial`. Parsed and generated/rebuilt definition marker tokens plus native source-backed marker edits are now covered; finish remaining marker-group, lazy-continuation, nested-block, loose-definition, source-map, writer, and reparse-stability edges before promotion.
...
- [ ] **P1 - Finish `UseDefinitionLists`.** Type: engine plus proof. Parsed and generated/rebuilt definition marker tokens plus source-backed native fields are covered; remaining work is source-map and writer edge breadth for grouped markers, lazy continuation, nested blocks, loose definitions, and reparse stability.
...
- [ ] Stop broad fixture-chasing and work the remaining rows in this order.
  ...
  - [ ] `UseDefinitionLists`: parsed and generated/rebuilt definition marker syntax plus source-backed native fields are covered; finish remaining source-map and writer edge breadth for marker groups, lazy continuation, nested blocks, and reparse stability; promote only after nested source/native and writer evidence is complete.
