...
- [ ] **5. Close `UseAbbreviations`.** Existing behavior is real but still `Partial`. Parse-owned Markdown writing preserves abbreviation definitions, and nested link-label, blockquote, list, and pipe-table-cell expansion has Markdig comparison plus AST/native proof. Finish remaining Markdig edge breadth and any remaining parser/source/writer deltas before promotion.
...
- [ ] Stop broad fixture-chasing and work the remaining rows in this order.
  ...
  - [ ] `UseAbbreviations`: parse-owned Markdown writing preserves abbreviation definition syntax, and nested link-label, blockquote, list, and pipe-table-cell expansion now has Markdig and AST/native proof; finish remaining Markdig edge breadth and any remaining parser/source/writer deltas before promotion.
