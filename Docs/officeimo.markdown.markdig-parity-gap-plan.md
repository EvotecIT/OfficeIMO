...
- [ ] **Promote or explicitly bound `UseDefinitionLists`.**
  ...
  - [ ] Broaden nested-body cases for blockquotes, fenced code, HTML, setext headings, setext-looking lines inside `<dd>`, and list tails beyond the immediate nested-list item boundary.
