...
| CommonMark corpus | 270 of 652 official CommonMark `0.31.2` examples pinned as smoke fixtures |
| CommonMark full inventory | 590 of 652 official CommonMark `0.31.2` examples currently match; 62 are failing in `Docs/officeimo.markdown.commonmark-inventory.md` |
...
- [ ] Fix the 17 remaining link/reference failures: blockquote-contained definitions, nested link precedence, inline precedence with HTML/code/autolinks, linked-image reference rendering, and shared image/link grammar.
...
| Link reference definitions | 9 | 27 | 18 | Reference-definition grammar |
