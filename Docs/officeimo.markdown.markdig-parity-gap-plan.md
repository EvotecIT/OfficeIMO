...
- [ ] **P0 - Finish the active `UseDefinitionLists` promotion.**
  ...
  - [ ] Engine: close nested-body breadth for blockquotes, fenced code, setext headings, setext-looking lines inside `<dd>`, and remaining list-tail variants after nested body boundaries.
...
- [ ] **Promote or explicitly bound `UseDefinitionLists`.**
  ...
  - [ ] Broaden nested-body cases for blockquote source breadth, fenced code, setext headings, setext-looking lines inside `<dd>`, and remaining list-tail variants after nested body boundaries.
