...
- Simple connector-to-shape crossings, group-child crossings, and connector-to-connector crossings are now covered by deterministic obstacle-aware route scoring plus page-level optimization sweeps, but dense network layouts still need richer route candidates for deeper whole-page minimization.
...
1. Extend obstacle-aware orthogonal routing beyond the new page-level optimization sweeps into richer route candidates for dense whole-page minimization.
