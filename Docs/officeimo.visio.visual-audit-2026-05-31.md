...
- Connector label cleanup now runs a second stabilization pass over all current labels, ignores generated adornment shapes, and can avoid unrelated connector paths, reducing order-sensitive label and line collisions in dense pages.
...
2. Continue connector label cleanup beyond current connector-path-aware and lifeline-aware placement with denser graph, whole-page, and deeper sequence edge-case strategies.
