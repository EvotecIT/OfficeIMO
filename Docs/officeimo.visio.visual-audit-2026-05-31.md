...
- `CreateStencilProfile()` now summarizes generated-master, package-backed, basic-geometry, and stencil-backed shape usage plus Shape Data keys, semantic kind usage, stencil catalogs, categories, keywords, aliases, tags, source package paths, typed stencil-family rollups, family-level stencil ids/search metadata/tags, master-kind counts, placed width/height ranges, and connection-point richness from inspection snapshots; generated and package-backed stencil provenance survives save/load.
...
6. Expand stencil extraction beyond current catalog/category/source-pack/family provenance, aliases, keywords, tags, placed dimensions, and connection-point rollups into icon/preview metadata, richer package-family details, default-source dimensions, and deeper native-pack metadata.
