...
7. Expand stencil extraction beyond current catalog/category/source-pack/family provenance into icon/preview metadata, richer package-family details, aliases, dimensions, and deeper native-pack metadata.
