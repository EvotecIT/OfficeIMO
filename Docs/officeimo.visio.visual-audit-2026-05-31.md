...
2. Continue connector label cleanup beyond the current lifeline-aware sequence message placement with denser graph, whole-page, and deeper sequence edge-case strategies.
