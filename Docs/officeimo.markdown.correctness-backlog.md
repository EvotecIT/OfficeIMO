...
- list-item rewrites now preserve parsed syntax children when the canonical `BlockChildren` projection is unchanged, avoiding source-map degradation during no-op or identity AST passes
