...
- Broaden typed stencil profiles from the new catalog/category/source-pack metadata into richer connection-point, icon/preview, and package-family profiles as metadata extraction expands.
