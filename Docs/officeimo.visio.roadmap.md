...
- Add CI artifacts for generated showcase previews, including native SVG/PNG outputs from `--visio-showcase --visio-native-preview` and desktop Visio previews where Visio is installed.
