...
Later lanes can add DataTable/DataSet-style import/export, styles, filters,
conditional formatting, and preserved unsupported feature counts, then merge the
opt-in JSON output into the existing comparison summary format.
