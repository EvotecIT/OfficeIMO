...
- the Markdig comparison baseline is now guarded so `OfficeIMO.Shared.Tests`, `OfficeIMO.Markdown.Tests`, `OfficeIMO.Markdown.Benchmarks`, and the public compatibility docs cannot silently drift to different Markdig versions
