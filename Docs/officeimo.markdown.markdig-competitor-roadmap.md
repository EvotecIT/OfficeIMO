...
- standards smoke baseline: 231 CommonMark `0.31.2` fixtures, 36 cmark-gfm extension fixtures, and a focused upstream ignored-autolink crash regression
