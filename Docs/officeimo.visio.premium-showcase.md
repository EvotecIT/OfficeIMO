...
6. Use the new graph node/edge record import path for inventory-driven gallery scenarios such as identity/authentication flow, Kubernetes/service-mesh topology, and data-platform dependency maps, keeping generated connector ids stable for structural diffs.
