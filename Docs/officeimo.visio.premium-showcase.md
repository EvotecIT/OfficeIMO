...
4. Extend current premium inspection/profile baselines beyond typed family and connection-point rollups into icon/preview metadata, richer package-family details, aliases, dimensions, and deeper native-pack metadata as external metadata extraction improves.
