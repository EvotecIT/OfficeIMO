...
2. Replace the remaining basic geometry with stencil-backed premium symbols where the domain supports it; architecture, executive dependency, network segmentation, and print audit trail samples now carry first-party stencil provenance.
