...
| Render pages | Managed Drawing projection for supported paths, clipping, forms, images, shadings, patterns, appearances, alpha, blend modes, masks, fonts, and color spaces | Type 3/CFF, ICC LUT/CMYK profiles, advanced patterns, and incomplete layer cases remain in per-page diagnostics |
