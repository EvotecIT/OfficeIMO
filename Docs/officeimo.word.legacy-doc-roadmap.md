...
- [ ] Expand native writer slices for formatting, tables, and simple
  ...
  - [x] Read and write simple zero-length, same-paragraph, and cross-paragraph
    body bookmark ranges through native DOC `SttbfBkmk`, `Plcfbkf`, and
  ...
  - [ ] Add bookmark locations outside body paragraphs, richer visual table style
    effects, nested tables, section breaks inside richer body shapes, and richer
    section writing as separate preflight-backed slices.
