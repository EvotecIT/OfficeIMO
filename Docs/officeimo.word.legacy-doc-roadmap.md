...
- [ ] Expand native writer slices for formatting, tables, and simple
  ...
  - [x] Read and write simple zero-length and same-paragraph body bookmark
    ranges through native DOC `SttbfBkmk`, `Plcfbkf`, and `Plcfbkl` records,
    then use those records to round-trip authored internal bookmark hyperlinks.
  ...
  - [ ] Add cross-paragraph bookmark ranges, bookmark locations outside body
    paragraphs, richer visual table style effects, nested tables, section breaks
