...
- Literal autolinks in text: `http(s)://...`, `www.example.com`, `user@example.com`, and selected bare schemes such as `mailto:`, `ftp://`, `tel:`, and `xmpp:` when enabled (configurable via `MarkdownReaderOptions`)
...
- Autolinks
  - Literal autolinks cover common cases (`http(s)://...`, `www.*`, plain emails, selected bare schemes such as `mailto:`, `ftp://`, `tel:`, and `xmpp:`, and angle-bracket absolute URIs like `mailto:`, `ftp://`, `tel:`, and `urn:`) but do not aim for full spec coverage.
