...
public sealed partial class PdfOptions {
    ...
    public PdfOptions Clone() {
        var clone = new PdfOptions {
            ...
            _headerZoneSegments = _headerZoneSegments?.Clone(),
            _firstPageHeaderZoneSegments = _firstPageHeaderZoneSegments?.Clone(),
            _evenPageHeaderZoneSegments = _evenPageHeaderZoneSegments?.Clone(),
            _footerZoneSegments = _footerZoneSegments?.Clone(),
            _firstPageFooterZoneSegments = _firstPageFooterZoneSegments?.Clone(),
            _evenPageFooterZoneSegments = _evenPageFooterZoneSegments?.Clone(),
