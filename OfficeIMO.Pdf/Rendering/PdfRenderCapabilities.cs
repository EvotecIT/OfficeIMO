...
public static class PdfRenderCapabilities {
    ...
    private static System.Collections.ObjectModel.ReadOnlyCollection<PdfRenderCapability> BuildRegistry() {
        var entries = new[] {
            ...
            Entry(IccMabColorSpaceId, "color", "ICC v4 mAB ICCBased color spaces", PdfRenderSupportLevel.Supported, "Intent-invariant RGB and CMYK A2B0 mAB transforms are applied with at most 33 CLUT grid points per input dimension and 65,536 entries per embedded curve."),
            ...
            Entry("render.colorspace.alternate", "color", "Separation, DeviceN, and NChannel alternate color spaces", PdfRenderSupportLevel.Supported, "Bounded exponential, linear and cubic sampled, stitching, and identity calculator tint transforms are projected through their declared alternate color space."),
