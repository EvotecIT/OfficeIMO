...
public static class PdfRenderCapabilities {
    ...
    private static System.Collections.ObjectModel.ReadOnlyCollection<PdfRenderCapability> BuildRegistry() {
        var entries = new[] {
            ...
            Entry("render.colorspace.alternate", "color", "Separation, DeviceN, and NChannel alternate color spaces", PdfRenderSupportLevel.Supported, "Bounded exponential, linear sampled, stitching, and identity calculator tint transforms are projected through their declared alternate color space."),
