...
public static class PdfRenderCapabilities {
    ...
    private static System.Collections.ObjectModel.ReadOnlyCollection<PdfRenderCapability> BuildRegistry() {
        var entries = new[] {
            ...
            Entry(Type3FontSubstitutionId, "resource", "Type 3 font glyph programs", PdfRenderSupportLevel.Simplified, "Text is decoded and positioned, but bounded Type 3 glyph programs are not executed and glyphs are rendered through a mapped system font."),
