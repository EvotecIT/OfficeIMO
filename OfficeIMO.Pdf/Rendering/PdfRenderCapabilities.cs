...
public static class PdfRenderCapabilities {
    ...
    private static System.Collections.ObjectModel.ReadOnlyCollection<PdfRenderCapability> BuildRegistry() {
        var entries = new[] {
            ...
            Entry(Type3MetricsId, "operator", "d0 and d1 Type 3 glyph metric operators", PdfRenderSupportLevel.Simplified, "Type 3 glyph metric operators are accepted inside bounded glyph programs; text advances use the font Widths contract."),
            ...
            Entry(OptionalImageCodecId, "resource", "JPEG 2000 and optional raster codecs", PdfRenderSupportLevel.Simplified, "The image encoding is outside the managed raster engine; supported source bytes can use a caller-supplied IOfficeRasterImageCodec, while JPEG 2000 remains diagnosed when it cannot be projected into the shared Drawing scene."),
