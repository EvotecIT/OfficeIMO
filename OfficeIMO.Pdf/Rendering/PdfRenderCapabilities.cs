...
public static class PdfRenderCapabilities {
    ...
    private static System.Collections.ObjectModel.ReadOnlyCollection<PdfRenderCapability> BuildRegistry() {
        var entries = new[] {
            ...
            Entry("render.resource.font-type3", "resource", "Type 3 vector and raster-image glyph programs", PdfRenderSupportLevel.Supported, "Bounded Type 3 vector and normalized raster-image glyph programs are projected with their font matrix, text transform, clipping, paint type, resources, and page paint order."),
