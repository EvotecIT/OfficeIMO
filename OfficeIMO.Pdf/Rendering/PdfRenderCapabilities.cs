...
public static class PdfRenderCapabilities {
    ...
    private static System.Collections.ObjectModel.ReadOnlyCollection<PdfRenderCapability> BuildRegistry() {
        var entries = new[] {
            ...
            Entry(ColorSpaceId, "color", "CalGray, CalRGB, Lab, ICCBased, Indexed, and Separation-family color spaces", PdfRenderSupportLevel.Unsupported, "The color-space resource is not projected by the managed renderer."),
