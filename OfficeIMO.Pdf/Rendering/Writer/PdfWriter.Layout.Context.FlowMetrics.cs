...
internal static partial class PdfWriter {
    private sealed partial class LayoutContext {
        ...
        private double MeasureNextParagraphFirstLineHeight(RichParagraphBlock paragraph, double frameX, double frameWidth, double fontSize) {
            ...
            var wrap = WrapRichRunsCore(paragraph.Runs, textFrame.Width, fontSize, ChooseNormal(currentOpts.DefaultFont), leading, textFrame.FirstLineWidth, GetParagraphTabStopWidth(paragraphStyle), currentOpts, GetParagraphTabStops(paragraphStyle));
