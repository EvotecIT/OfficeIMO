...
internal static class PdfPageXObjectInvocationParser {
    ...
    private sealed class Parser {
            ...
            for (int i = 0; i < bytes.Length; i++) {
                ...
                if (glyphs != null) {
                    ...
                    glyphs.Add(new PdfPageType3GlyphInvocation(
                        ...
                        _hasAuthoredRenderingIntent, _renderingIntent, _fillColorSelection, _strokeColorSelection, _state.StrokeDashPattern));
                }
        ...
        private PdfPageGraphicsStateResource CaptureCurrentGraphicsState() => new PdfPageGraphicsStateResource(
            ...
            strokeDashPattern: _state.StrokeDashPattern);
        ...
        private void PublishActiveGraphicsEffectUse(PdfType3PaintChannels channels) {
            ...
            var resource = new PdfPageGraphicsStateResource(
                ...
                strokeDashPattern: softMaskState.HasValue ? softMaskState.Value.StrokeDashPattern : _state.StrokeDashPattern);
    ...
    private readonly struct GraphicsState {
        private GraphicsState(
            ...
            PdfStrokeDashPattern? strokeDashPattern,
        ...
        public static GraphicsState Create(Matrix2D transform) =>
            Create(transform, null, PdfPageColorSpaceKind.DeviceGray, null, null, null, PdfPageColorSpaceKind.DeviceGray, null, null, null, null, null, OfficeBlendMode.Normal, null, false, false, false);
        ...
        public GraphicsState WithStrokeDashStyle(OfficeStrokeDashStyle? strokeDashStyle) => new GraphicsState(Transform, ClipPath, FillColor, FillColorSpace, FillOpacity, StrokeColor, StrokeColorSpace, StrokeOpacity, StrokeWidth, strokeDashStyle, null, StrokeLineCap, StrokeLineJoin, BlendMode, AuthoredBlendMode, HasUnsupportedBlendMode, HasUnsupportedPaintState, HasSoftMask);
