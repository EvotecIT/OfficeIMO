...
public sealed partial class PdfLogicalDocument {
    ...
    /// <summary>Page-level additional actions attached to source page dictionaries.</summary>
    ...
    /// <summary>True when at least one page-level additional action was read.</summary>
    public bool HasPageActions => PageActions.Count > 0;

    /// <summary>Number of page-level additional actions read.</summary>
    public int PageActionCount => PageActions.Count;

    /// <summary>Distinct page-level action types in first-seen order.</summary>
    ...
    /// <summary>Distinct page-level additional-action trigger keys in first-seen order.</summary>
    ...
    /// <summary>Distinct page-level action paths in first-seen order.</summary>
