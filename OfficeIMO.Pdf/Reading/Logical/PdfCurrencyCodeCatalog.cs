...
/// <summary>Shared ISO 4217 code recognition for PDF value parsing and electronic-invoice validation.</summary>
internal static class PdfCurrencyCodeCatalog {
    private static readonly string[] Codes = {
        ...
        "XAU", "XBA", "XBB", "XBC", "XBD", "XCD", "XCG", "XDR", "XOF", "XPD", "XPF",
        "XPT", "XSU", "XTS", "XUA", "YER", "ZAR", "ZMW", "ZWG", "ZWL"
    };

    internal static bool IsKnown(string value) {
        string normalized = value.Trim().ToUpperInvariant();
        return Array.BinarySearch(Codes, normalized, StringComparer.Ordinal) >= 0;
    }
}
