...
internal static class PdfTextSpanGeometry {
    internal static PdfTextSpanBounds GetAxisAlignedBounds(PdfTextSpan span) {
        ...
        double x2 = span.X + normalX * descent;
        double y2 = span.Y + normalY * descent;
        double x3 = span.X + alongX * advance + normalX * descent;
        double y3 = span.Y + alongY * advance + normalY * descent;
