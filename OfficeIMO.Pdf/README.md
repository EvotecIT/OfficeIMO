...
- Shares managed CMYK, Lab, XYZ, calibrated-color conversion, bounded linear and cubic sampled plus nested stitching color functions, vector tiling fills, standard blend modes, and alpha/luminosity soft masks with `OfficeIMO.Drawing`.
