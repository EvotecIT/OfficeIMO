...
internal sealed partial class PdfDocumentReader {
    ...
    /// </summary>
    public PdfDocumentInfo DocumentInfo(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public PdfMetadata Metadata(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public PdfDocumentSecurityInfo Security(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfPageInfo> Pages(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public PdfPageInfo? Page(int pageNumber, PdfLoadOptions? readOptions = null) {
        if (pageNumber <= 0) {
    ...
    /// </summary>
    public string? HeaderVersion(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public string? EffectiveVersion(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public bool IsPdf20OrLater(PdfLoadOptions? readOptions = null) {
