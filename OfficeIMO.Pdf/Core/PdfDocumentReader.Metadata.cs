...
internal sealed partial class PdfDocumentReader {
    ...
    /// </summary>
    public PdfXmpMetadataInfo? XmpMetadata(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfOutputIntentInfo> OutputIntents(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfOutputIntentInfo> OutputIntentsBySubtype(string subtype, PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfOutputIntentInfo> OutputIntentsByOutputConditionIdentifier(string outputConditionIdentifier, PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public PdfTaggedContentInfo? TaggedContent(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public PdfOptionalContentProperties? OptionalContent(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfOptionalContentGroup> OptionalContentGroups(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfOptionalContentGroup> OptionalContentGroupsByName(string name, PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfAttachmentInfo> AttachmentMetadata(PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfAttachmentInfo> AttachmentMetadataByName(string name, PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfAttachmentInfo> AttachmentMetadataByFileName(string fileName, PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfAttachmentInfo> AttachmentMetadataBySource(string source, PdfLoadOptions? readOptions = null) {
    ...
    /// </summary>
    public IReadOnlyList<PdfAttachmentInfo> AttachmentMetadataByRelationship(PdfAssociatedFileRelationship relationship, PdfLoadOptions? readOptions = null) {
