...
public sealed partial class PdfCiiInvoiceDocument {
    ...
    private PdfCiiInvoiceDocument(byte[] bytes, XDocument document) {
        _bytes = bytes;
        _document = document;
    }
    ...
    public static PdfCiiInvoiceDocument Load(byte[] xml) {
        ...
        return new PdfCiiInvoiceDocument(bytes, document);
    }
    ...
    private PdfCiiInvoiceDocument ReplaceScalar(string value, bool requireDateFormat, params XName[] path) {
