...
namespace OfficeIMO.PowerPoint {
    ...
    public class ObjectFlattenerOptions {
        ...
        /// columns are kept. A match occurs when the full dotted path matches or the last segment matches.
        /// </summary>
        public string[] IncludeProperties { get; set; } = Array.Empty<string>();
        /// <summary>
        /// Optional convenience exclude list using property names or dotted paths. A match occurs when the full
        /// dotted path matches or the last segment matches. This augments <see cref="Ignore"/>.
        /// </summary>
        public string[] ExcludeProperties { get; set; } = Array.Empty<string>();
        /// <summary>
        /// Optional list of dotted paths to pin to the front of the generated column order when
        /// <see cref="Columns"/> is not specified.
        /// </summary>
        public string[] PinnedFirst { get; set; } = Array.Empty<string>();
        /// <summary>Optional list of dotted paths to pin to the end of the generated column order.</summary>
        public string[] PinnedLast { get; set; } = Array.Empty<string>();
        /// <summary>
        /// Optional per-column priority ordering. Lower numbers appear earlier. Keys can be dotted paths or
        /// property names.
        /// </summary>
        ...
        /// Example: map path "ScoreBreakdown" with KeyProperty="Name", ValueProperty="Value" to produce columns
        /// like "ScoreBreakdown.HasMX".
        /// </summary>
        ...
        /// Any argument may be null; order is applied as PinFirst then PriorityOrder then PinLast.
        /// </summary>
    ...
    public class ObjectFlattener {
        ...
        private static void FlattenInternal(object obj, Dictionary<string, object?> dict, string prefix, int depth, ObjectFlattenerOptions opts) {
            ...
            var props = Cache.GetOrAdd(type, t => t.GetProperties(BindingFlags.Public | BindingFlags.Instance)
        ...
        private static void FlattenValueTuple(object obj, Dictionary<string, object?> dict, string prefix, int depth, ObjectFlattenerOptions opts) {
            ...
            if (iTupleType != null && iTupleType.IsAssignableFrom(obj.GetType())) {
                ...
                var itemProp = iTupleType.GetProperty("Item");
