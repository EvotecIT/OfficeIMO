        ...
        private static readonly IReadOnlyList<LegacyPptCapability> CapabilityRows =
            new ReadOnlyCollection<LegacyPptCapability>(new[] {
                ...
                Planned(LegacyPptFeature.BulletsAndNumbering, "Text", "Bullet glyphs, pictures, numbering, and levels.",
                    "Base character bullets project and write native enabled/disabled state, glyph, resolved font and color, relative or point size, level, and ruler indentation. PPT9 StyleTextProp9Atom extensions decode and author all 41 classic automatic-numbering schemes with exact start values, including repeated run groups; fresh PPT/POT/PPS writing and append-only imported shape edits support add, change, and removal. Fresh master title/body/other defaults write the base character-bullet contract. PPT9 picture bullets and automatic-numbering defaults inherited through TextMasterStyle9Atom remain planned."),
