        ...
        private static readonly IReadOnlyList<LegacyPptCapability> CapabilityRows =
            new ReadOnlyCollection<LegacyPptCapability>(new[] {
                ...
                Planned(LegacyPptFeature.Hyperlinks, "Interaction", "Text and shape hyperlinks.",
                    "ExObjList, ExHyperlink, and PP9 ExHyperlink9 records decode to typed targets, external URL/file relationships, and screen tips. Shape click/hover and exact half-open text ranges project natively, write to new PPT/POT/PPS files, and support preservation-aware add/edit/remove operations and appended slides. Target frames, internal slide targets, custom-show flags, and richer hyperlink metadata remain planned."),
                Planned(LegacyPptFeature.Actions, "Interaction", "Shape actions, slide jumps, and programs.",
                    "InteractiveInfoAtom click and mouse-over records decode to typed action metadata. Next, previous, first, last, last-viewed, and end-show jumps project and write natively, including preservation-aware edits. Macro, program, custom-show, OLE, media, sound, and visited-state actions remain preserve-only or planned."),
