        ...
        private static readonly IReadOnlyList<LegacyPptCapability> CapabilityRows =
            new ReadOnlyCollection<LegacyPptCapability>(new[] {
                ...
                new LegacyPptCapability(LegacyPptFeature.RichText, "Text",
                    ...
                    "StyleTextPropAtom character runs project bold, italic, underline, point size, direct or resolved scheme color, baseline position, and document font-collection typefaces natively. Embedded font programs and legacy-only character effects remain preserve-only. Unmodified formatting and unrelated supported edits round-trip; formatting edits and fresh binary rich-text authoring remain planned."),
                Planned(LegacyPptFeature.ParagraphFormatting, "Text", "Alignment, indentation, spacing, tabs, and margins.",
                    "StyleTextPropAtom paragraph runs project alignment, line and paragraph spacing, level, font alignment, RTL direction, East Asian breaking, Latin word wrapping, and hanging punctuation natively. Text rulers, explicit margins and tabs, master inheritance, edited binary writing, and fresh authoring remain planned."),
                Planned(LegacyPptFeature.BulletsAndNumbering, "Text", "Bullet glyphs, pictures, numbering, and levels.",
                    "Base character bullets project native enabled/disabled state, glyph, resolved font and color, relative or point size, and level. Picture bullets, auto-numbering extensions, ruler indentation, master inheritance, edited binary writing, and fresh authoring remain planned."),
