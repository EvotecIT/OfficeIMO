        ...
        private static readonly IReadOnlyList<LegacyPptCapability> CapabilityRows =
            new ReadOnlyCollection<LegacyPptCapability>(new[] {
                ...
                new LegacyPptCapability(LegacyPptFeature.AutoShapes, "Drawing",
                    ...
                    LegacyPptCapabilityState.Preserved,
                    LegacyPptCapabilityState.Planned,
                    "OfficeArt preset geometry with a DrawingML equivalent is projected as an editable native shape, including arrows, callouts, flowcharts, ribbons, stars, and action buttons. Fresh PPT/POT/PPS writing maps the canonical classic preset families back to native OfficeArt shape types. All eight signed adjustment slots are decoded without losing their shape-specific meaning; exact round-rectangle and donut adjustments are projected natively. Unmodified imported geometry is byte-preserved, and supported transform or style edits retain it. Edited preset adjustments, custom geometry, text warps, and DrawingML-only presets remain loss-blocked until they can be represented without silent geometry changes."),
                ...
                new LegacyPptCapability(LegacyPptFeature.ShapeTransforms,
                    ...
                    LegacyPptCapabilityState.Preserved,
                    LegacyPptCapabilityState.Planned,
                    "Position, size, clockwise rotation, and horizontal or vertical mirroring are projected for mapped shapes, pictures, connectors, and nested groups. Fresh top-level slide and master shapes write native OfficeArt anchors, rotation, and flip flags. Imported top-level slide and supported master shape transform edits append incremental FSP, FOPT, and anchor records while preserving unrelated rich properties. Nested child transforms, group coordinate edits, reparenting, and explicit z-order edits remain planned."),
