        ...
        private static readonly IReadOnlyList<LegacyPptCapability> CapabilityRows =
            new ReadOnlyCollection<LegacyPptCapability>(new[] {
                ...
                new LegacyPptCapability(LegacyPptFeature.RichText, "Text",
                    ...
                    "StyleTextPropAtom character runs project bold, italic, underline, point size, direct or resolved scheme color, and baseline position natively. Typeface indexes and legacy-only effects remain preserve-only until font collections and effect inheritance are mapped. Unmodified formatting and unrelated supported edits round-trip; formatting edits and fresh binary rich-text authoring remain planned."),
