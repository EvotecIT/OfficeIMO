        ...
        private static readonly IReadOnlyList<LegacyPptCapability> CapabilityRows =
            new ReadOnlyCollection<LegacyPptCapability>(new[] {
                ...
                Planned(LegacyPptFeature.Hyperlinks, "Interaction", "Text and shape hyperlinks.",
                    "ExObjList and ExHyperlink records decode to typed targets and external URL/file relationships. Shape click/hover and exact half-open text ranges project natively, write to new PPT/POT/PPS files, and support preservation-aware add/edit/remove operations and appended slides. PP9 screen tips, target frames, internal slide targets, and richer flags remain planned."),
