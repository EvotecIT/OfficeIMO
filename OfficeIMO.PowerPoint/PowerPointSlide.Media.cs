...
namespace OfficeIMO.PowerPoint {
    public partial class PowerPointSlide {
        ...
        public PowerPointMedia AddVideo(Stream video, string contentType, string extension, long left = 0L, long top = 0L,
            ...
            PowerPointImagePartType posterImageType = PowerPointImagePartType.Png) {
        ...
        private ImagePart AddGeneratedMediaPoster(PowerPointMediaKind kind) {
            ...
            return AddImagePartFromStream(stream, PowerPointImagePartType.Png);
        }
        ...
        private ImagePart AddImagePartFromStream(Stream image, PowerPointImagePartType imageType) {
            if (image == null) {
