...
try {
    ...
    $expectedDirectDependencies = @{
        ...
        'OfficeIMO.Word.IWork' = @('OfficeIMO.IWork', 'OfficeIMO.Word')
        'OfficeIMO.Excel.IWork' = @('OfficeIMO.Excel', 'OfficeIMO.IWork')
        'OfficeIMO.PowerPoint.IWork' = @('OfficeIMO.IWork', 'OfficeIMO.PowerPoint')
