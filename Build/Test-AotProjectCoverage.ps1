...
if ($fullyRootedLibraries.Count -ne 108) {
    throw "Expected 108 fully rooted production libraries across the ordinary and optional-adapter hosts, found $($fullyRootedLibraries.Count)."
}
