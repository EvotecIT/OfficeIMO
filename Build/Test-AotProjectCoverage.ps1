...
if ($fullyRootedLibraries.Count -ne 103) {
    throw "Expected 103 fully rooted production libraries across the ordinary and optional-adapter hosts, found $($fullyRootedLibraries.Count)."
}
