...
if ($fullyRootedLibraries.Count -ne 107) {
    throw "Expected 107 fully rooted production libraries across the ordinary and optional-adapter hosts, found $($fullyRootedLibraries.Count)."
}
