...
if ($fullyRootedLibraries.Count -ne 109) {
    throw "Expected 109 fully rooted production libraries across the ordinary and optional-adapter hosts, found $($fullyRootedLibraries.Count)."
}
