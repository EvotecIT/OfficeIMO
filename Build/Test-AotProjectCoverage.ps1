...
if ($fullyRootedLibraries.Count -ne 106) {
    throw "Expected 106 fully rooted production libraries across the ordinary and optional-adapter hosts, found $($fullyRootedLibraries.Count)."
}
