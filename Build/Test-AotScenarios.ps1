...
$scenarios = @(
    ...
    [ordered]@{ id = 'html-tool'; title = 'HTML production CLI startup and capability discovery'; project = 'OfficeIMO.Html.Tool/OfficeIMO.Html.Tool.csproj'; targetFramework = 'net10.0'; aotValidation = $true; runArguments = @('--help') }
)
