...
$scenarios = @(
    [ordered]@{ id = 'production-libraries'; title = 'Production library coverage: 88 fully rooted plus bounded Google adapter'; project = 'OfficeIMO.All.AotSmoke/OfficeIMO.All.AotSmoke.csproj'; targetFramework = 'net10.0' },
