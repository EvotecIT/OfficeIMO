    ...
    public class PowerPointPictureValidationTests {
        ...
        public void AddPictureStream_ThrowsOnNullStream() {
            ...
            try {
                ...
                Assert.Throws<ArgumentNullException>(() => slide.AddPicture(null!, OfficeIMO.Drawing.OfficeImageFormat.Png, 0, 0, 1000, 1000));
            } finally {
        ...
        public void AddPictureStream_ThrowsOnUnreadableStream() {
            ...
            try {
                ...
                Assert.Throws<ArgumentException>(() => slide.AddPicture(stream, OfficeIMO.Drawing.OfficeImageFormat.Png, 0, 0, 1000, 1000));
            } finally {
        ...
        public void AddPictureStream_ThrowsOnInvalidSize(long width, long height) {
            ...
            try {
                ...
                Assert.Throws<ArgumentOutOfRangeException>(() => slide.AddPicture(stream, OfficeIMO.Drawing.OfficeImageFormat.Png, 0, 0, width, height));
            } finally {
                if (File.Exists(filePath)) {
                    File.Delete(filePath);
                }
