...
/// <summary>
/// RTF ingestion adapter for <see cref="DocumentReader"/>.
/// </summary>
public static partial class DocumentReaderRtfExtensions {
    ...
    private static IEnumerable<ReaderChunk> ReadRtfDocument(RtfDocument document, SourceMetadata source, ReaderOptions readerOptions, ReaderRtfOptions rtfOptions, IReadOnlyList<RtfDiagnostic> diagnostics, CancellationToken cancellationToken) {
