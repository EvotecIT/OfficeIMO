...
public partial class DrawingTests {
    ...
    public void OfficeSvgDrawingReader_MapsLocalMasksAndBlendModesIntoSharedEffectGroups() {
        const string svg = """
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 4">
              <defs>
                <mask id="left-half" maskContentUnits="userSpaceOnUse" style="mask-type:luminance">
    ...
    public void OfficeSvgDrawingReader_DeterministicMutationFuzzRemainsBounded() {
        byte[] seed = Encoding.UTF8.GetBytes("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 20'><defs><mask id='m'><rect width='20' height='20' fill='white'/></mask></defs><g mask='url(#m)' style='mix-blend-mode:multiply'><path d='M0 0 L40 20 Z' fill='red'/></g></svg>");
