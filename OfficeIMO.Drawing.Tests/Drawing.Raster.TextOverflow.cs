...
public partial class DrawingRasterTests {
    ...
    [Fact]
    public void OfficeRasterCanvas_PositionedTextKeepsItsBaselineWhenTheFrameHeightChanges() {
        ...
        var positioned = new OfficeDrawing(180D, 40D).AddPositionedText(
            ...
            OfficeColor.Black);
        var taller = new OfficeDrawing(180D, 40D).AddPositionedText(
            text,
            3D,
            0D,
            advance,
        ...
        AssertRasterImagesEqual(
            OfficeDrawingRasterRenderer.Render(taller),
