...
Supported export coverage includes semantic paragraphs, rich runs, list markers, page setup, metadata, tables, PNG/JPEG images, bookmarks, field result text, hidden text control, and running header/footer text including first-page and even-page variants.
