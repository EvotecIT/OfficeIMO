...
Supported export coverage includes semantic paragraphs, rich runs, list markers, page setup, metadata, tables, PNG/JPEG images, bookmarks, field result text, hidden text control, footnote/endnote/annotation bodies, and running header/footer text including first-page and even-page variants.
