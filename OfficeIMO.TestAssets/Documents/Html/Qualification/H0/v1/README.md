...
This versioned fixture is a hand-authored static business report used to establish the OfficeIMO HTML qualification baseline. It is independent of the OfficeIMO HTML generators and exercises a normal page/resource boundary:
