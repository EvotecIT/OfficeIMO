...
public static class OfficeDocumentPdfConverter {
    ...
    public static PdfDocumentConversionResult EmailToPdfBytes(
        Stream source,
    ...
    public static PdfDocumentConversionResult EpubToPdfBytes(
        Stream source,
    ...
    public static PdfDocumentConversionResult VisioToPdfBytes(
        Stream source,
